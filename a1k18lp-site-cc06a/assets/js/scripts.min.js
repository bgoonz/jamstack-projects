!(function () {
  for (
    ...
    r.setAttribute("href", "#" + e[t].getAttribute("id")),
      r.classList.add("anchor"),
      r.appendChild(i),
      e[t].insertBefore(r, e[t].firstChild);
  }
})();
var Zepto = (function () {
  function u(t) {
  ...
  return (
    ...
    (F.init = function (t, e) {
      ...
      if (!t) return F.Z();
      if ("string" == typeof t)
        if ("<" == (t = t.trim())[0] && O.test(t))
          (n = F.fragment(t, RegExp.$1, e)), (t = null);
        else {
        ...
        if (J(t))
          ...
          (n = F.fragment(t.trim(), RegExp.$1, e)), (t = null);
        else {
          if (e !== y) return b(e).find(t);
          n = F.qsa(C, t);
        }
    ...
    (b.fn = {
      ...
      closest: function (t, e) {
        var n = this[0],
          i = !1;
        for (
          "object" == typeof t && (i = b(t));
          n && !(i ? 0 <= i.indexOf(n) : F.matches(n, t));

        )
          n = n !== e && !s(n) && n.parentNode;
        return b(n);
      },
      parents: function (t) {
        for (var e = [], n = this; 0 < n.length; )
          n = b.map(n, function (t) {
            return (t = t.parentNode) && !s(t) && e.indexOf(t) < 0
              ? (e.push(t), t)
              : void 0;
          });
        return p(e, t);
      ...
      css: function (t, e) {
        if (arguments.length < 2) {
          var n,
            i = this[0];
          if (!i) return;
          if (((n = getComputedStyle(i, "")), "string" == typeof t))
            return i.style[L(t)] || n.getPropertyValue(t);
          if (J(t)) {
            var r = {};
            return (
      ...
      offsetParent: function () {
        return this.map(function () {
          for (
            ...
            t && !M.test(t.nodeName) && "static" == b(t).css("position");
      ...
      (b.fn[e] = function () {
        var e,
          ...
          r = b.map(arguments, function (t) {
            return "object" == (e = u(t)) || "array" == e || null == t
              ? t
              : F.fragment(t);
          }),
          o = 1 < this.length;
        ...
        (b.fn[s ? e + "To" : "insert" + (a ? "Before" : "After")] = function (
          t
        ) {
      ...
      t.split(/\s/).forEach(function (t) {
        ...
        (n.fn = e),
          ...
          n.e in E &&
            (e = function (t) {
              ...
              return !e || (e !== this && !l.contains(this, e))
        ...
        (n.proxy = function (t) {
          ...
          "addEventListener" in r &&
            r.addEventListener(d(n.e), n.proxy, p(n, u));
      });
    }
        ...
        a(e, t, n, i).forEach(function (t) {
          delete L[o][t.i],
            "removeEventListener" in e &&
              e.removeEventListener(d(t.e), t.proxy, p(t, r));
        });
      });
    }
    function v(i, r) {
      return (
        (r || !i.isDefaultPrevented) &&
          ...
          (r.defaultPrevented !== y
            ? r.defaultPrevented
            : "returnValue" in r
            ? !1 === r.returnValue
            : r.getPreventDefault && r.getPreventDefault()) &&
            (i.isDefaultPrevented = s)),
        i
      );
    }
    function g(t) {
    ...
    (l.fn.delegate = function (t, e, n) {
                  ...
                  (u = function (t) {
                    ...
                    return n && n !== i
                      ? ((e = l.extend(g(t), {
                        ...
                        (s || o).apply(n, [e].concat(x.call(arguments, 1))))
                      : void 0;
                  }),
                c(i, e, o, n, r, u || s);
            }));
      ...
      (l.fn.trigger = function (t, e) {
        return (
          ...
          this.each(function () {
            t.type in i && "function" == typeof this[t.type]
              ? this[t.type]()
          ...
          this.each(function (t, e) {
            ((r = g(w(n) ? l.Event(n) : n))._args = i),
              ...
              l.each(a(e, n.type || n), function (t, e) {
                return (
                  (o = e.proxy(r)), !r.isImmediatePropagationStopped() && void 0
                );
              });
          }),
          o
  ...
  (function (dh) {
    ...
    function ih(t, e) {
      ...
      return (
        ...
        !1 !== fh(e, n, "ajaxBeforeSend", [t, e]) &&
        void fh(e, n, "ajaxSend", [t, e])
      );
    }
    function jh(t, e, n, i) {
      var r = n.context,
    ...
    function qh(t, e, n, i) {
      return (
        dh.isFunction(e) && ((i = n), (n = e), (e = void 0)),
    ...
    (Ch.href = window.location.href),
        ...
        return (
          ...
          dh(s).on("load error", function (t, e) {
            clearTimeout(o),
              ...
              "error" != t.type && r
                ? jh(r[0], c, n, i)
                : kh(null, e || "error", c, n, i),
              (window[a] = u),
              r && dh.isFunction(u) && u(r[0]),
              (u = r = void 0);
          }),
          !1 === ih(c, n)
            ? e("abort")
      ...
      (dh.ajax = function (Ji) {
        ...
        for (sh in dh.ajaxSettings)
          void 0 === Li[sh] && (Li[sh] = dh.ajaxSettings[sh]);
        (Mh = Li).global && 0 == dh.active++ && fh(Mh, null, "ajaxStart"),
          Li.crossDomain ||
            (((Ki = vh.createElement("a")).href = Li.url),
            (Ki.href = Ki.href),
            (Li.crossDomain =
              Ch.protocol + "//" + Ch.host != Ki.protocol + "//" + Ki.host)),
          Li.url || (Li.url = window.location.toString()),
          (ii = Li).processData &&
            ii.data &&
            "string" != dh.type(ii.data) &&
            (ii.data = dh.param(ii.data, ii.traditional)),
          !ii.data ||
            (ii.type && "GET" != ii.type.toUpperCase()) ||
            ((ii.url = oh(ii.url, ii.data)), (ii.data = void 0));
        var Ni = Li.dataType,
          Oi = /\?.+=\?/.test(Li.url);
        if (
          (Oi && (Ni = "jsonp"),
          (!1 !== Li.cache &&
            ((Ji && !0 === Ji.cache) || ("script" != Ni && "jsonp" != Ni))) ||
            (Li.url = oh(Li.url, "_=" + Date.now())),
          "jsonp" == Ni)
        )
          return (
            Oi ||
              (Li.url = oh(
                Li.url,
                Li.jsonp ? Li.jsonp + "=?" : !1 === Li.jsonp ? "" : "callback=?"
              )),
            dh.ajaxJSONP(Li, Mi)
          );
        var Pi,
        ...
        if (
          ...
          Si("Accept", Qi || "*/*"),
          (Qi = Li.mimeType || Qi) &&
            (-1 < Qi.indexOf(",") && (Qi = Qi.split(",", 2)[0]),
            Ui.overrideMimeType && Ui.overrideMimeType(Qi)),
          (Li.contentType ||
            (!1 !== Li.contentType &&
              Li.data &&
              "GET" != Li.type.toUpperCase())) &&
            Si(
              "Content-Type",
              Li.contentType || "application/x-www-form-urlencoded"
            ),
          Li.headers)
        )
          ...
          !(Ui.onreadystatechange = function () {
            if (4 == Ui.readyState) {
              ...
              var Zi,
                $i = !1;
              if (
                (200 <= Ui.status && Ui.status < 300) ||
                304 == Ui.status ||
                (0 == Ui.status && "file:" == Ti)
              ) {
                (Ni =
                  Ni ||
                  ((fi = Li.mimeType || Ui.getResponseHeader("content-type")) &&
                    (fi = fi.split(";", 2)[0]),
                  (fi &&
                    (fi == Ah
                      ? "html"
                ...
                try {
                  "script" == Ni
                    ...
                    ? (Zi = Ui.responseXML)
                    : "json" == Ni &&
                      (Zi = Bh.test(Zi) ? null : dh.parseJSON(Zi));
                } catch (t) {
                  $i = t;
                }
        ...
        for (th in (Ui.open(Li.type, Li.url, Wi, Li.username, Li.password), Ri))
          Vi.apply(Ui, Ri[th]);
        return (
          0 < Li.timeout &&
            ...
            (a = dh.type(e)),
              o &&
                (t = r
                  ...
                  : o +
                    "[" +
                    (u || "object" == a || "array" == a ? t : "") +
                    "]"),
              !o && s
                ? i.add(e.name, e.value)
                : "array" == a || (!r && "object" == a)
                ? n(i, e, r, t)
                : i.add(t, e);
          });
...
!(function (e, o) {
  ...
  return function (e, o) {
    ...
    setTimeout(function () {
      if (T()) return;
      v.addEventListener("mouseleave", p),
        v.addEventListener("mouseenter", y),
        v.addEventListener("keydown", b);
    }, r);
    var E = !1;
    function b(e) {
      E ||
        (e.metaKey && 76 === e.keyCode && ((E = !0), (f = setTimeout(w, u))));
    }
    function x(e, o) {
      return (
        (function () {
          for (
            var e = document.cookie.split("; "), o = {}, i = e.length - 1;
            0 <= i;
            i--
          ) {
            var n = e[i].split("=");
...
!(function () {
  ...
  function o() {
    0 != document.body.scrollTop || 0 != document.documentElement.scrollTop
      ? (window.scrollBy(0, -50), (e = setTimeout(o, 10)))
      : clearTimeout(e);
  }
})();
!(function (n) {
  ...
  (t.prototype = {
    ...
    _init: function () {
      ...
      i.items.forEach(function (t, e) {
        o(t) &&
          (i._checkTotalRendered(),
          classie.add(t, "shown"),
          r(t.querySelector(".preload")));
      }),
        n.addEventListener(
          "scroll",
          function () {
        ...
        classie.has(i, "shown") ||
          ...
          setTimeout(function () {
            ...
            if (
              ...
              var e =
                Math.random() *
                  (n.options.maxDuration - n.options.minDuration) +
                n.options.minDuration +
                "s";
              (i.style.WebkitAnimationDuration = e),
                (i.style.MozAnimationDuration = e),
                (i.style.animationDuration = e);
            }
    ...
    _checkTotalRendered: function () {
      ++this.itemsRenderedCount,
        this.itemsRenderedCount === this.itemsCount &&
          n.removeEventListener("scroll", this._onScrollFn);
    },
  }),
    (n.AnimOnScroll = t);
})(window);
                ...
                ? ((n = c(this).val()),
                  ...
                  c.each(o, function (e, t) {
                    for (e = 0; e < a.length; e++)
                      void 0 !== t[a[e]] &&
                        -1 !== t[a[e]].toLowerCase().indexOf(n.toLowerCase()) &&
                        (s.push(t), (e = a.length));
                  }),
                  (t = s),
                  r(),
...
!(function (e, t) {
  ...
  function (y) {
    ...
    var n,
          ...
          var r = function (e) {
            for (var t in e)
              Object.prototype.hasOwnProperty.call(e, t) &&
                (o && "[object Object]" === Object.prototype.toString.call(e[t])
                  ? (n[t] = I(!0, n[t], e[t]))
                  : (n[t] = e[t]));
          };
          e < t;
      ...
      H = function (e) {
        return null === e
          ? 0
          : ((t = e),
            Math.max(t.scrollHeight, t.offsetHeight, t.clientHeight) +
              e.offsetTop);
        var t;
      };
    o.animateScroll = function (i, u, e) {
      var t,
        n =
          (t = i ? i.getAttribute("data-options") : null) &&
          "object" == typeof JSON &&
      ...
      var a = function () {
        ...
        (h = 1 < (h = (v += 16) / parseInt(s.speed, 10)) ? 1 : h),
          ...
          (a = d),
          (c = y.pageYOffset),
          (o == r || c == r || y.innerHeight + c >= b) &&
            (clearInterval(a), l.focus(), s.callback(i, u));
      };
    ...
    var a = function (e) {
        var t = (function (e, t) {
          ...
          for (
            "[" === r &&
            1 < (n = (t = t.substr(1, t.length - 2)).split("=")).length &&
        ...
        t &&
          ...
          (e.preventDefault(), o.animateScroll(t, t.hash, n));
      },
      i = function (e) {
        t ||
    ...
    return (
      (o.destroy = function () {
        n &&
          (y.document.removeEventListener("click", a, !1),
          y.removeEventListener("resize", i, !1),
          (O = c = t = n = null));
      }),
      (o.init = function (e) {
        r &&
          (o.destroy(),
          (n = I(S, e || {})),
          (c = y.document.querySelector(n.selectorHeader)),
          (O = H(c)),
          y.document.addEventListener("click", a, !1),
          c && y.addEventListener("resize", i, !1));
      }),
      o
    );
  }
...
!(function () {
  for (var n = document.links, o = 0, t = n.length; o < t; o++)
    n[o].hostname != window.location.hostname && (n[o].target = "_blank");
})();
!(function () {
  "use strict";
    ...
    document.addEventListener("scroll", function () {
      ...
      if (((v.style.bottom = g < n && y ? "0%" : "-100%"), n <= E)) {
        var r = n / E,
          i = (100 * r).toFixed(2),
          o = 100 - parseFloat(i);
        (h.style.width = i.toString() + "%"),
          (S.style.width = o.toString() + "%");
...
!(function (o, e, a) {
  o("#menu").click(function () {
    o("body").addClass("push-menu-to-right"),
      o("#sidebar").addClass("open"),
      o(".overlay").addClass("show");
  }),
    o("#mask").click(function () {
      o("body").removeClass("push-menu-to-right"),
        o("#sidebar").removeClass("open"),
        o(".overlay").removeClass("show");
    }),
    o(e).scroll(function () {
      0 < o(this).scrollTop()
        ? o("body").addClass("light")
        : o("body").removeClass("light");
    });
  var s = o(".modal .close");
  s.on("click", function () {
  ...
  function n() {
    o(".search-wrapper").toggleClass("active"),
      l.searchform.toggleClass("active"),
      l.canvas.removeClass("search-overlay");
  }
  l.dothis.on("click", function () {
    o(".search-wrapper").toggleClass("active"),
      l.searchform.toggleClass("active"),
      l.searchform.find("input").focus(),
      l.canvas.toggleClass("search-overlay"),
      o(".search-field").simpleJekyllSearch();
  }),
    l.close.on("click", n),
    document.addEventListener("keyup", function (e) {
      27 == e.keyCode && o(".search-overlay").length && n();
    }),
    1 <= document.getElementsByClassName("home").length &&
