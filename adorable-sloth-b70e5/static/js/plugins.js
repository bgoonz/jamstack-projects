...
!(function (t, e) {
  ...
  function h(t) {
    for (var e, n = arguments, i = 1; i < n.length; ++i)
      if ((e = n[i])) for (var s in e) l(t, s) && (t[s] = e[s]);
    return t;
  }
  var r = {},
    d = {
        ...
        n(e, [
          {
            ...
            value: function () {
              this.folds = [];
              for (
                var t = this.element.children, e = 0, n = t.length;
                e < n;
                e += 2
              ) {
                var i = t[e],
          ...
          },
          {
            ...
            value: function (t) {
              for (
                var e = this.folds.length, n = null, i = 0;
                i < e && null === n;
                i++
              )
