!(function (e, t) {
  ...
  return (function () {
    ...
    var s = function e(t) {
      ...
      h = (function () {
        function e(e) {
          (this.displayMode = void 0),
            ...
            (e = e || {}),
            (this.displayMode = l.deflt(e.displayMode, !1)),
            (this.output = l.deflt(e.output, "htmlAndMathml")),
            (this.leqno = l.deflt(e.leqno, !1)),
            (this.fleqn = l.deflt(e.fleqn, !1)),
            (this.throwOnError = l.deflt(e.throwOnError, !0)),
            (this.errorColor = l.deflt(e.errorColor, "#cc0000")),
            (this.macros = e.macros || {}),
            (this.minRuleThickness = Math.max(
              0,
              l.deflt(e.minRuleThickness, 0)
            )),
            (this.colorIsTextColor = l.deflt(e.colorIsTextColor, !1)),
            (this.strict = l.deflt(e.strict, "warn")),
            (this.trust = l.deflt(e.trust, !1)),
            (this.maxSize = Math.max(0, l.deflt(e.maxSize, 1 / 0))),
            (this.maxExpand = Math.max(0, l.deflt(e.maxExpand, 1e3))),
            (this.globalGroup = l.deflt(e.globalGroup, !1));
        }
        var t = e.prototype;
        return (
      ...
      g = [1, 1, 3, 3, 5, 5, 7, 7],
      v = [0, 1, 2, 3, 2, 3, 2, 3],
      b = { DISPLAY: c[0], TEXT: c[2], SCRIPT: c[4], SCRIPTSCRIPT: c[6] },
      y = [
        {
          name: "latin",
          blocks: [
    ...
    var k = 80,
      ...
      B = function (e) {
        var t = "<" + e;
        this.classes.length &&
          (t += ' class="' + l.escape(z(this.classes)) + '"');
        var r = "";
        for (var n in this.style)
          this.style.hasOwnProperty(n) &&
            (r += l.hyphenate(n) + ":" + this.style[n] + ";");
        ...
        function e(e, t, r, n, a, i, o, s) {
          ...
          var l = (function (e) {
            for (var t = 0; t < y.length; t++)
              for (var r = y[t], n = 0; n < r.blocks.length; n++) {
                var a = r.blocks[n];
          ...
          l && this.classes.push(l + "_fallback"),
            /[\xee\xef\xed\xec]/.test(this.text) && (this.text = I[this.text]);
        }
        var t = e.prototype;
        return (
          (t.hasClass = function (e) {
          ...
          (t.toNode = function () {
            ...
            this.classes.length > 0 &&
              ((t = t || document.createElement("span")).className = z(
                this.classes
              )),
            this.style))
              this.style.hasOwnProperty(r) &&
          ...
          (t.toNode = function () {
            ...
            return (
              this.alternate
                ...
                : e.setAttribute("d", S[this.pathName]),
              e
            );
          }),
          (t.toMarkup = function () {
    ...
    function V(e, t, r) {
      ...
      var n = e.charCodeAt(0),
        a = D[t][n];
      if (
        (!a && e[0] in F && ((n = F[e[0]].charCodeAt(0)), (a = D[t][n])),
        a || "text" !== r || (w(n) && (a = D[t][77])),
        a)
      )
        return {
          depth: a[0],
    ...
    var G = {};
    var U = { bin: 1, close: 1, inner: 1, open: 1, punct: 1, rel: 1 },
      Y = {
        "accent-token": 1,
        mathord: 1,
        "op-token": 1,
    ...
    function _(e, t, r, n, a, i) {
      (W[e][a] = { font: t, group: r, replace: n }),
        i && n && (W[e][n] = W[e][a]);
    }
    var j = "math",
      $ = "text",
    ...
    _(j, Z, oe, "\u2261", "\\equiv", !0),
      ...
      _(j, Z, oe, "\u22c8", "\\bowtie", !0),
      _(j, Z, oe, "\u2323", "\\smile", !0),
      _(j, Z, oe, "\u2291", "\\sqsubseteq", !0),
      _(j, Z, oe, "\u2292", "\\sqsupseteq", !0),
      _(j, Z, oe, "\u2250", "\\doteq", !0),
      _(j, Z, oe, "\u2322", "\\frown", !0),
      _(j, Z, oe, "\u220b", "\\ni", !0),
      _(j, Z, oe, "\u221d", "\\propto", !0),
      ...
      _(j, Z, le, "\u2118", "\\wp", !0),
      _(j, Z, le, "\u266f", "\\sharp", !0),
      _(j, Z, le, "\u2662", "\\diamondsuit", !0),
      _(j, Z, le, "\u211c", "\\Re", !0),
      _(j, Z, le, "\u2661", "\\heartsuit", !0),
      _(j, Z, le, "\u2111", "\\Im", !0),
      _(j, Z, le, "\u2660", "\\spadesuit", !0),
      _(j, Z, le, "\xa7", "\\S", !0),
      _($, Z, le, "\xa7", "\\S"),
      _(j, Z, le, "\xb6", "\\P", !0),
      _($, Z, le, "\xb6", "\\P"),
      ...
      _($, Z, le, "\u2021", "\\ddag"),
      _($, Z, le, "\u2021", "\\textdaggerdbl"),
      _(j, Z, ee, "\u23b1", "\\rmoustache", !0),
      _(j, Z, ae, "\u23b0", "\\lmoustache", !0),
      _(j, Z, ee, "\u27ef", "\\rgroup", !0),
      _(j, Z, ae, "\u27ee", "\\lgroup", !0),
      _(j, Z, Q, "\u2213", "\\mp", !0),
      _(j, Z, Q, "\u2296", "\\ominus", !0),
      ...
      _(j, Z, Q, "\u2a3f", "\\amalg"),
      _(j, Z, Q, "&", "\\And"),
      _(j, Z, oe, "\u27f5", "\\longleftarrow", !0),
      _(j, Z, oe, "\u21d0", "\\Leftarrow", !0),
      _(j, Z, oe, "\u27f8", "\\Longleftarrow", !0),
      _(j, Z, oe, "\u27f6", "\\longrightarrow", !0),
      _(j, Z, oe, "\u21d2", "\\Rightarrow", !0),
      _(j, Z, oe, "\u27f9", "\\Longrightarrow", !0),
      _(j, Z, oe, "\u2194", "\\leftrightarrow", !0),
      _(j, Z, oe, "\u27f7", "\\longleftrightarrow", !0),
      _(j, Z, oe, "\u21d4", "\\Leftrightarrow", !0),
      _(j, Z, oe, "\u27fa", "\\Longleftrightarrow", !0),
      _(j, Z, oe, "\u21a6", "\\mapsto", !0),
      _(j, Z, oe, "\u27fc", "\\longmapsto", !0),
      _(j, Z, oe, "\u2197", "\\nearrow", !0),
      _(j, Z, oe, "\u21a9", "\\hookleftarrow", !0),
      _(j, Z, oe, "\u21aa", "\\hookrightarrow", !0),
      _(j, Z, oe, "\u2198", "\\searrow", !0),
      _(j, Z, oe, "\u21bc", "\\leftharpoonup", !0),
      _(j, Z, oe, "\u21c0", "\\rightharpoonup", !0),
      _(j, Z, oe, "\u2199", "\\swarrow", !0),
      _(j, Z, oe, "\u21bd", "\\leftharpoondown", !0),
      _(j, Z, oe, "\u21c1", "\\rightharpoondown", !0),
      _(j, Z, oe, "\u2196", "\\nwarrow", !0),
      _(j, Z, oe, "\u21cc", "\\rightleftharpoons", !0),
      _(j, K, oe, "\u226e", "\\nless", !0),
      _(j, K, oe, "\ue010", "\\@nleqslant"),
      _(j, K, oe, "\ue011", "\\@nleqq"),
      _(j, K, oe, "\u2a87", "\\lneq", !0),
      ...
      _(j, K, oe, "\u22ea", "\\ntriangleleft"),
      _(j, K, oe, "\u22ec", "\\ntrianglelefteq", !0),
      _(j, K, oe, "\u228a", "\\subsetneq", !0),
      _(j, K, oe, "\ue01a", "\\@varsubsetneq"),
      _(j, K, oe, "\u2acb", "\\subsetneqq", !0),
      _(j, K, oe, "\ue017", "\\@varsubsetneqq"),
      _(j, K, oe, "\u226f", "\\ngtr", !0),
      _(j, K, oe, "\ue00f", "\\@ngeqslant"),
      _(j, K, oe, "\ue00e", "\\@ngeqq"),
      _(j, K, oe, "\u2a88", "\\gneq", !0),
      ...
      _(j, K, oe, "\u22e1", "\\nsucceq", !0),
      _(j, K, oe, "\u22e9", "\\succnsim", !0),
      _(j, K, oe, "\u2aba", "\\succnapprox", !0),
      _(j, K, oe, "\u2246", "\\ncong", !0),
      _(j, K, oe, "\ue007", "\\@nshortparallel"),
      _(j, K, oe, "\u2226", "\\nparallel", !0),
      _(j, K, oe, "\u22af", "\\nVDash", !0),
      _(j, K, oe, "\u22eb", "\\ntriangleright"),
      _(j, K, oe, "\u22ed", "\\ntrianglerighteq", !0),
      _(j, K, oe, "\ue018", "\\@nsupseteqq"),
      _(j, K, oe, "\u228b", "\\supsetneq", !0),
      _(j, K, oe, "\ue01b", "\\@varsupsetneq"),
      _(j, K, oe, "\u2acc", "\\supsetneqq", !0),
      _(j, K, oe, "\ue019", "\\@varsupsetneqq"),
      _(j, K, oe, "\u22ae", "\\nVdash", !0),
      _(j, K, oe, "\u2ab5", "\\precneqq", !0),
      _(j, K, oe, "\u2ab6", "\\succneqq", !0),
      _(j, K, oe, "\ue016", "\\@nsubseteqq"),
      ...
      _(j, K, oe, "\u21ae", "\\nleftrightarrow", !0),
      _(j, K, oe, "\u21ce", "\\nLeftrightarrow", !0),
      _(j, K, oe, "\u25b3", "\\vartriangle"),
      _(j, K, le, "\u210f", "\\hslash"),
      _(j, K, le, "\u25bd", "\\triangledown"),
      _(j, K, le, "\u25ca", "\\lozenge"),
      _(j, K, le, "\u24c8", "\\circledS"),
      _(j, K, le, "\xae", "\\circledR"),
      _($, K, le, "\xae", "\\circledR"),
      _(j, K, le, "\u2221", "\\measuredangle", !0),
      _(j, K, le, "\u2204", "\\nexists"),
      _(j, K, le, "\u2127", "\\mho"),
      _(j, K, le, "\u2132", "\\Finv", !0),
      _(j, K, le, "\u2141", "\\Game", !0),
      _(j, K, le, "\u2035", "\\backprime"),
      _(j, K, le, "\u25b2", "\\blacktriangle"),
      _(j, K, le, "\u25bc", "\\blacktriangledown"),
      _(j, K, le, "\u25a0", "\\blacksquare"),
      _(j, K, le, "\u29eb", "\\blacklozenge"),
      _(j, K, le, "\u2605", "\\bigstar"),
      _(j, K, le, "\u2222", "\\sphericalangle", !0),
      _(j, K, le, "\u2201", "\\complement", !0),
      _(j, K, le, "\xf0", "\\eth", !0),
      _($, Z, le, "\xf0", "\xf0"),
      _(j, K, le, "\u2571", "\\diagup"),
      _(j, K, le, "\u2572", "\\diagdown"),
      ...
      _(j, K, le, "\xa5", "\\yen", !0),
      _($, K, le, "\xa5", "\\yen", !0),
      _(j, K, le, "\u2713", "\\checkmark", !0),
      _($, K, le, "\u2713", "\\checkmark"),
      _(j, K, le, "\u2136", "\\beth", !0),
      _(j, K, le, "\u2138", "\\daleth", !0),
      _(j, K, le, "\u2137", "\\gimel", !0),
      _(j, K, le, "\u03dd", "\\digamma", !0),
      _(j, K, le, "\u03f0", "\\varkappa"),
      _(j, K, ae, "\u250c", "\\@ulcorner", !0),
      _(j, K, ee, "\u2510", "\\@urcorner", !0),
      _(j, K, ae, "\u2514", "\\@llcorner", !0),
      ...
      _(j, K, oe, "\u2266", "\\leqq", !0),
      _(j, K, oe, "\u2a7d", "\\leqslant", !0),
      _(j, K, oe, "\u2a95", "\\eqslantless", !0),
      _(j, K, oe, "\u2272", "\\lesssim", !0),
      _(j, K, oe, "\u2a85", "\\lessapprox", !0),
      _(j, K, oe, "\u224a", "\\approxeq", !0),
      _(j, K, Q, "\u22d6", "\\lessdot"),
      _(j, K, oe, "\u22d8", "\\lll", !0),
      _(j, K, oe, "\u2276", "\\lessgtr", !0),
      _(j, K, oe, "\u22da", "\\lesseqgtr", !0),
      _(j, K, oe, "\u2a8b", "\\lesseqqgtr", !0),
      _(j, K, oe, "\u2251", "\\doteqdot"),
      _(j, K, oe, "\u2253", "\\risingdotseq", !0),
      _(j, K, oe, "\u2252", "\\fallingdotseq", !0),
      _(j, K, oe, "\u223d", "\\backsim", !0),
      _(j, K, oe, "\u22cd", "\\backsimeq", !0),
      _(j, K, oe, "\u2ac5", "\\subseteqq", !0),
      _(j, K, oe, "\u22d0", "\\Subset", !0),
      _(j, K, oe, "\u228f", "\\sqsubset", !0),
      _(j, K, oe, "\u227c", "\\preccurlyeq", !0),
      _(j, K, oe, "\u22de", "\\curlyeqprec", !0),
      _(j, K, oe, "\u227e", "\\precsim", !0),
      _(j, K, oe, "\u2ab7", "\\precapprox", !0),
      _(j, K, oe, "\u22b2", "\\vartriangleleft"),
      _(j, K, oe, "\u22b4", "\\trianglelefteq"),
      _(j, K, oe, "\u22a8", "\\vDash", !0),
      _(j, K, oe, "\u22aa", "\\Vvdash", !0),
      _(j, K, oe, "\u2323", "\\smallsmile"),
      _(j, K, oe, "\u2322", "\\smallfrown"),
      ...
      _(j, K, oe, "\u2267", "\\geqq", !0),
      _(j, K, oe, "\u2a7e", "\\geqslant", !0),
      _(j, K, oe, "\u2a96", "\\eqslantgtr", !0),
      _(j, K, oe, "\u2273", "\\gtrsim", !0),
      _(j, K, oe, "\u2a86", "\\gtrapprox", !0),
      _(j, K, Q, "\u22d7", "\\gtrdot"),
      _(j, K, oe, "\u22d9", "\\ggg", !0),
      _(j, K, oe, "\u2277", "\\gtrless", !0),
      _(j, K, oe, "\u22db", "\\gtreqless", !0),
      _(j, K, oe, "\u2a8c", "\\gtreqqless", !0),
      _(j, K, oe, "\u2256", "\\eqcirc", !0),
      _(j, K, oe, "\u2257", "\\circeq", !0),
      _(j, K, oe, "\u225c", "\\triangleq", !0),
      _(j, K, oe, "\u223c", "\\thicksim"),
      _(j, K, oe, "\u2248", "\\thickapprox"),
      _(j, K, oe, "\u2ac6", "\\supseteqq", !0),
      _(j, K, oe, "\u22d1", "\\Supset", !0),
      _(j, K, oe, "\u2290", "\\sqsupset", !0),
      _(j, K, oe, "\u227d", "\\succcurlyeq", !0),
      _(j, K, oe, "\u22df", "\\curlyeqsucc", !0),
      _(j, K, oe, "\u227f", "\\succsim", !0),
      _(j, K, oe, "\u2ab8", "\\succapprox", !0),
      _(j, K, oe, "\u22b3", "\\vartriangleright"),
      _(j, K, oe, "\u22b5", "\\trianglerighteq"),
      _(j, K, oe, "\u22a9", "\\Vdash", !0),
      _(j, K, oe, "\u2223", "\\shortmid"),
      _(j, K, oe, "\u2225", "\\shortparallel"),
      _(j, K, oe, "\u226c", "\\between", !0),
      _(j, K, oe, "\u22d4", "\\pitchfork", !0),
      _(j, K, oe, "\u221d", "\\varpropto"),
      _(j, K, oe, "\u25c0", "\\blacktriangleleft"),
      _(j, K, oe, "\u2234", "\\therefore", !0),
      _(j, K, oe, "\u220d", "\\backepsilon"),
      _(j, K, oe, "\u25b6", "\\blacktriangleright"),
      _(j, K, oe, "\u2235", "\\because", !0),
      _(j, K, oe, "\u22d8", "\\llless"),
      _(j, K, oe, "\u22d9", "\\gggtr"),
      _(j, K, Q, "\u22b2", "\\lhd"),
      ...
      _(j, K, oe, "\u2251", "\\Doteq", !0),
      _(j, K, Q, "\u2214", "\\dotplus", !0),
      _(j, K, Q, "\u2216", "\\smallsetminus"),
      _(j, K, Q, "\u22d2", "\\Cap", !0),
      _(j, K, Q, "\u22d3", "\\Cup", !0),
      _(j, K, Q, "\u2a5e", "\\doublebarwedge", !0),
      _(j, K, Q, "\u229f", "\\boxminus", !0),
      _(j, K, Q, "\u229e", "\\boxplus", !0),
      _(j, K, Q, "\u22c7", "\\divideontimes", !0),
      _(j, K, Q, "\u22c9", "\\ltimes", !0),
      _(j, K, Q, "\u22ca", "\\rtimes", !0),
      _(j, K, Q, "\u22cb", "\\leftthreetimes", !0),
      _(j, K, Q, "\u22cc", "\\rightthreetimes", !0),
      _(j, K, Q, "\u22cf", "\\curlywedge", !0),
      _(j, K, Q, "\u22ce", "\\curlyvee", !0),
      _(j, K, Q, "\u229d", "\\circleddash", !0),
      _(j, K, Q, "\u229b", "\\circledast", !0),
      _(j, K, Q, "\u22c5", "\\centerdot"),
      _(j, K, Q, "\u22ba", "\\intercal", !0),
      _(j, K, Q, "\u22d2", "\\doublecap"),
      _(j, K, Q, "\u22d3", "\\doublecup"),
      _(j, K, Q, "\u22a0", "\\boxtimes", !0),
      _(j, K, oe, "\u21e2", "\\dashrightarrow", !0),
      _(j, K, oe, "\u21e0", "\\dashleftarrow", !0),
      _(j, K, oe, "\u21c7", "\\leftleftarrows", !0),
      _(j, K, oe, "\u21c6", "\\leftrightarrows", !0),
      _(j, K, oe, "\u21da", "\\Lleftarrow", !0),
      _(j, K, oe, "\u219e", "\\twoheadleftarrow", !0),
      _(j, K, oe, "\u21a2", "\\leftarrowtail", !0),
      _(j, K, oe, "\u21ab", "\\looparrowleft", !0),
      _(j, K, oe, "\u21cb", "\\leftrightharpoons", !0),
      _(j, K, oe, "\u21b6", "\\curvearrowleft", !0),
      _(j, K, oe, "\u21ba", "\\circlearrowleft", !0),
      _(j, K, oe, "\u21b0", "\\Lsh", !0),
      _(j, K, oe, "\u21c8", "\\upuparrows", !0),
      _(j, K, oe, "\u21bf", "\\upharpoonleft", !0),
      _(j, K, oe, "\u21c3", "\\downharpoonleft", !0),
      _(j, Z, oe, "\u22b6", "\\origof", !0),
      _(j, Z, oe, "\u22b7", "\\imageof", !0),
      _(j, K, oe, "\u22b8", "\\multimap", !0),
      _(j, K, oe, "\u21ad", "\\leftrightsquigarrow", !0),
      _(j, K, oe, "\u21c9", "\\rightrightarrows", !0),
      _(j, K, oe, "\u21c4", "\\rightleftarrows", !0),
      _(j, K, oe, "\u21a0", "\\twoheadrightarrow", !0),
      _(j, K, oe, "\u21a3", "\\rightarrowtail", !0),
      _(j, K, oe, "\u21ac", "\\looparrowright", !0),
      _(j, K, oe, "\u21b7", "\\curvearrowright", !0),
      _(j, K, oe, "\u21bb", "\\circlearrowright", !0),
      _(j, K, oe, "\u21b1", "\\Rsh", !0),
      _(j, K, oe, "\u21ca", "\\downdownarrows", !0),
      _(j, K, oe, "\u21be", "\\upharpoonright", !0),
      _(j, K, oe, "\u21c2", "\\downharpoonright", !0),
      _(j, K, oe, "\u21dd", "\\rightsquigarrow", !0),
      _(j, K, oe, "\u21dd", "\\leadsto"),
      _(j, K, oe, "\u21db", "\\Rrightarrow", !0),
      _(j, K, oe, "\u21be", "\\restriction"),
      _(j, Z, le, "\u2018", "`"),
      _(j, Z, le, "$", "\\$"),
      _($, Z, le, "$", "\\$"),
      _($, Z, le, "$", "\\textdollar"),
      ...
      _(j, Z, re, "\u03bd", "\\nu", !0),
      _(j, Z, re, "\u03be", "\\xi", !0),
      _(j, Z, re, "\u03bf", "\\omicron", !0),
      _(j, Z, re, "\u03c0", "\\pi", !0),
      _(j, Z, re, "\u03c1", "\\rho", !0),
      _(j, Z, re, "\u03c3", "\\sigma", !0),
      _(j, Z, re, "\u03c4", "\\tau", !0),
      _(j, Z, re, "\u03c5", "\\upsilon", !0),
      _(j, Z, re, "\u03d5", "\\phi", !0),
      _(j, Z, re, "\u03c7", "\\chi", !0),
      _(j, Z, re, "\u03c8", "\\psi", !0),
      _(j, Z, re, "\u03c9", "\\omega", !0),
      _(j, Z, re, "\u03b5", "\\varepsilon", !0),
      _(j, Z, re, "\u03d1", "\\vartheta", !0),
      _(j, Z, re, "\u03d6", "\\varpi", !0),
      _(j, Z, re, "\u03f1", "\\varrho", !0),
      _(j, Z, re, "\u03c2", "\\varsigma", !0),
      _(j, Z, re, "\u03c6", "\\varphi", !0),
      _(j, Z, Q, "\u2217", "*"),
      _(j, Z, Q, "+", "+"),
      _(j, Z, Q, "\u2212", "-"),
      ...
      _(j, Z, le, "\u2202", "\\partial", !0),
      _(j, Z, Q, "\u2298", "\\oslash", !0),
      _(j, K, Q, "\u229a", "\\circledcirc", !0),
      _(j, K, Q, "\u22a1", "\\boxdot", !0),
      _(j, Z, Q, "\u25b3", "\\bigtriangleup"),
      _(j, Z, Q, "\u25bd", "\\bigtriangledown"),
      _(j, Z, Q, "\u2020", "\\dagger"),
      _(j, Z, Q, "\u22c4", "\\diamond"),
      _(j, Z, Q, "\u22c6", "\\star"),
      _(j, Z, Q, "\u25c3", "\\triangleleft"),
      _(j, Z, Q, "\u25b9", "\\triangleright"),
      _(j, Z, ae, "{", "\\{"),
      _($, Z, le, "{", "\\{"),
      _($, Z, le, "{", "\\textbraceleft"),
      _(j, Z, ee, "}", "\\}"),
      _($, Z, le, "}", "\\}"),
      _($, Z, le, "}", "\\textbraceright"),
      _(j, Z, ae, "{", "\\lbrace"),
      _(j, Z, ee, "}", "\\rbrace"),
      _(j, Z, ae, "[", "\\lbrack", !0),
      _($, Z, le, "[", "\\lbrack", !0),
      ...
      _(j, Z, le, "\u2225", "\\Vert"),
      _($, Z, le, "\u2225", "\\textbardbl"),
      _($, Z, le, "~", "\\textasciitilde"),
      _($, Z, le, "\\", "\\textbackslash"),
      _($, Z, le, "^", "\\textasciicircum"),
      _(j, Z, oe, "\u2191", "\\uparrow", !0),
      _(j, Z, oe, "\u21d1", "\\Uparrow", !0),
      _(j, Z, oe, "\u2193", "\\downarrow", !0),
      _(j, Z, oe, "\u21d3", "\\Downarrow", !0),
      _(j, Z, oe, "\u2195", "\\updownarrow", !0),
      _(j, Z, oe, "\u21d5", "\\Updownarrow", !0),
      _(j, Z, ne, "\u2210", "\\coprod"),
      _(j, Z, ne, "\u22c1", "\\bigvee"),
      _(j, Z, ne, "\u22c0", "\\bigwedge"),
    ...
    _($, Z, le, "\u2013", "--", !0),
      ...
      _($, Z, le, "\u2018", "\\textquoteleft"),
      _($, Z, le, "\u2019", "'", !0),
      _($, Z, le, "\u2019", "\\textquoteright"),
      _($, Z, le, "\u201c", "``", !0),
      _($, Z, le, "\u201c", "\\textquotedblleft"),
      _($, Z, le, "\u201d", "''", !0),
      _($, Z, le, "\u201d", "\\textquotedblright"),
      _(j, Z, le, "\xb0", "\\degree", !0),
      _($, Z, le, "\xb0", "\\degree"),
      _($, Z, le, "\xb0", "\\textdegree", !0),
      _(j, Z, le, "\xa3", "\\pounds"),
      _(j, Z, le, "\xa3", "\\mathsterling", !0),
      _($, Z, le, "\xa3", "\\pounds"),
      _($, Z, le, "\xa3", "\\textsterling", !0),
      _(j, K, le, "\u2720", "\\maltese"),
      _($, K, le, "\u2720", "\\maltese");
    ...
    for (
      var ge = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz", ve = 0;
      ve < ge.length;
      ve++
    ) {
      var be = ge.charAt(ve);
      _(j, Z, re, be, be), _($, Z, le, be, be);
    }
    _(j, K, le, "C", "\u2102"),
      _($, K, le, "C", "\u2102"),
      _(j, K, le, "H", "\u210d"),
      ...
      _(j, Z, re, "h", "\u210e"),
      _($, Z, re, "h", "\u210e");
    for (var ye = "", xe = 0; xe < ge.length; xe++) {
      var we = ge.charAt(xe);
      _(j, Z, re, we, (ye = String.fromCharCode(55349, 56320 + xe))),
        _($, Z, le, we, ye),
        _(j, Z, re, we, (ye = String.fromCharCode(55349, 56372 + xe))),
        _($, Z, le, we, ye),
        _(j, Z, re, we, (ye = String.fromCharCode(55349, 56424 + xe))),
        _($, Z, le, we, ye),
        _(j, Z, re, we, (ye = String.fromCharCode(55349, 56580 + xe))),
        _($, Z, le, we, ye),
        _(j, Z, re, we, (ye = String.fromCharCode(55349, 56736 + xe))),
        _($, Z, le, we, ye),
        _(j, Z, re, we, (ye = String.fromCharCode(55349, 56788 + xe))),
        _($, Z, le, we, ye),
        _(j, Z, re, we, (ye = String.fromCharCode(55349, 56840 + xe))),
        _($, Z, le, we, ye),
        _(j, Z, re, we, (ye = String.fromCharCode(55349, 56944 + xe))),
        _($, Z, le, we, ye),
        xe < 26 &&
          (_(j, Z, re, we, (ye = String.fromCharCode(55349, 56632 + xe))),
          _($, Z, le, we, ye),
          _(j, Z, re, we, (ye = String.fromCharCode(55349, 56476 + xe))),
          _($, Z, le, we, ye));
    }
    _(j, Z, re, "k", (ye = String.fromCharCode(55349, 56668))),
      _($, Z, le, "k", ye);
    for (var ke = 0; ke < 10; ke++) {
      var Se = ke.toString();
      _(j, Z, re, Se, (ye = String.fromCharCode(55349, 57294 + ke))),
        _($, Z, le, Se, ye),
        _(j, Z, re, Se, (ye = String.fromCharCode(55349, 57314 + ke))),
        _($, Z, le, Se, ye),
        _(j, Z, re, Se, (ye = String.fromCharCode(55349, 57324 + ke))),
        _($, Z, le, Se, ye),
        _(j, Z, re, Se, (ye = String.fromCharCode(55349, 57334 + ke))),
        _($, Z, le, Se, ye);
    }
    for (var Me = "\xc7\xd0\xde\xe7\xfe", ze = 0; ze < Me.length; ze++) {
      var Ae = Me.charAt(ze);
      _(j, Z, re, Ae, Ae), _($, Z, le, Ae, Ae);
    }
    var Te = [
      ...
      Ne = [0.5, 0.6, 0.7, 0.8, 0.9, 1, 1.2, 1.44, 1.728, 2.074, 2.488],
      Ce = function (e, t) {
        return t.size < 2 ? e : qe[e - 1][t.size - 1];
      },
      Ie = (function () {
        function e(t) {
          (this.style = void 0),
            ...
            (this.sizeMultiplier = Ne[this.size - 1]),
              ...
              this._fontMetrics ||
                (this._fontMetrics = (function (e) {
                  ...
                  if (!G[(t = e >= 5 ? 0 : e >= 3 ? 1 : 2)]) {
                    var r = (G[t] = { cssEmPerMu: P.quad[t] / 18 });
    ...
    var Re = Ie,
      ...
      He = function (e) {
        return (
          "string" != typeof e && (e = e.unit), e in Oe || e in Ee || "ex" === e
        );
      },
      Le = function (e, t) {
        var r;
        if (e.unit in Oe)
          r = Oe[e.unit] / t.fontMetrics().ptPerEm / t.sizeMultiplier;
      ...
      De = function (e, t, r) {
        return (
          X[r][e] && X[r][e].replace && (e = X[r][e].replace),
          { value: e, metrics: V(e, t, r) }
        );
      },
      Pe = function (e, t, r, n, a) {
        ...
        if (((e = o.value), s)) {
          ...
          ("text" === r || (n && "mathit" === n.font)) && (l = 0),
            (i = new R(e, s.height, s.depth, l, s.skew, s.width, a));
        } else
          "undefined" != typeof console &&
            console.warn(
      ...
      je = {
        ...
        mathsym: function (e, t, r, n) {
          return (
            void 0 === n && (n = []),
            "boldsymbol" === r.font && De(e, "Main-Bold", t).metrics
              ? Pe(e, "Main-Bold", t, r, n.concat(["mathbf"]))
              : "\\" === e || "main" === X[t][e].font
              ? Pe(e, "Main-Regular", t, r, n)
              : Pe(e, "AMS-Regular", t, r, n.concat(["amsrm"]))
          );
        },
        makeSpan: Ge,
        makeSvgSpan: Ue,
        ...
        makeVList: function (e, t) {
          for (
            var r = (function (e) {
                ...
                if ("top" === e.positionType) {
                  for (
                    var h = e.positionData, m = 0;
                    m < e.children.length;
                    m++
                  ) {
                    var c = e.children[m];
                    h -=
                      "kern" === c.type ? c.size : c.elem.height + c.elem.depth;
                  }
                  l = h;
          ...
          var z = Ge(["vlist-t"], x);
          return (
            2 === x.length && z.classes.push("vlist-t2"),
            (z.height = u),
            (z.depth = -c),
            z
          );
        ...
        makeOrd: function (e, t, r) {
          ...
          if (l) {
            ...
            if ("boldsymbol" === l) {
              ...
              s
                ? ((u = Xe[l].fontName), (p = [l]))
                : ((u = We(l, t.fontWeight, t.fontShape)),
            ...
            if (he.hasOwnProperty(i) && "Typewriter" === u.substr(0, 10)) {
              for (var f = [], g = 0; g < i.length; g++)
                f.push(Pe(i[g], u, a, t, o.concat(p)));
              return Ye(f);
            }
          }
          if ("mathord" === r)
            return Pe(i, "Math-Italic", a, t, o.concat(["mathnormal"]));
          if ("textord" === r) {
            ...
            if ("ams" === v) {
              ...
              return Pe(
                ...
                a,
                t,
                o.concat("amsrm", t.fontWeight, t.fontShape)
              );
            }
            if ("main" !== v && v) {
              var y = We(v, t.fontWeight, t.fontShape);
              return Pe(i, y, a, t, o.concat(y, t.fontWeight, t.fontShape));
            }
      ...
      Ke = { number: 5, unit: "mu" },
      Je = {
        mord: { mop: $e, mbin: Ze, mrel: Ke, minner: $e },
        mop: { mord: $e, mop: $e, mrel: Ke, minner: $e },
        mbin: { mord: Ze, mop: Ze, mopen: Ze, minner: Ze },
        mrel: { mord: Ke, mop: Ke, mopen: Ke, minner: Ke },
        mopen: {},
        mclose: { mop: $e, mbin: Ze, mrel: Ke, minner: $e },
        mpunct: {
          mord: $e,
          mop: $e,
          mrel: Ke,
    ...
    var it = function (e) {
      ...
      ut = function (e, t, r, n) {
        ...
        if ((je.tryCombineChars(a), !r)) return a;
        var h = t;
        if (1 === e.length) {
          var m = e[0];
          "sizing" === m.type
            ? (h = t.havingSize(m.size))
            : "styling" === m.type && (h = t.havingStyle(mt[m.style]));
        }
        ...
        return (
          pt(
            ...
            function (e, t) {
              var r = t.classes[0],
                n = e.classes[0];
              "mbin" === r && l.contains(ht, n)
                ? (t.classes[0] = "mord")
                : "mbin" === n && l.contains(lt, r) && (e.classes[0] = "mord");
            },
            { node: c },
            u,
            p
          ...
          pt(
            ...
            function (e, t) {
              var r = gt(t),
                n = gt(e),
                a =
                  r && n ? (e.hasClass("mtight") ? Qe[r][n] : Je[r][n]) : null;
              if (a) return je.makeGlue(a, h);
            },
            { node: c },
            u,
            p
      ...
      pt = function e(t, r, n, a, i) {
        ...
        for (var o = 0; o < t.length; o++) {
          ...
          if (l) e(l.children, r, n, null, i);
            ...
            h
              ? (n.node = s)
              : i && s.hasClass("newline") && (n.node = st(["leftmost"])),
      ...
      dt = function (e) {
        return e instanceof M ||
          e instanceof N ||
          (e instanceof q && e.hasClass("enclosing"))
          ? e
          : null;
      },
      ft = function e(t, r) {
    ...
    function xt(e, t) {
      ...
      for (var i, o = [], s = [], l = 0; l < a.length; l++)
        if (
          ...
          a[l].hasClass("mbin") ||
            a[l].hasClass("mrel") ||
            a[l].hasClass("allowbreak"))
        ) {
          for (
            var h = !1;
            l < a.length - 1 &&
            a[l + 1].hasClass("mspace") &&
            !a[l + 1].hasClass("newline");
          ...
          a[l].hasClass("newline") &&
            (s.pop(),
            s.length > 0 && (o.push(yt(s, t)), (s = [])),
            o.push(a[l]));
      s.length > 0 && o.push(yt(s, t)),
        r
          ? (((i = yt(ut(r, t, !0))).classes = ["tag"]), o.push(i))
          : n && o.push(n);
      var m = st(["katex-html"], o);
      if ((m.setAttribute("aria-hidden", "true"), i)) {
        var c = i.children[0];
        (c.style.height = m.height + m.depth + "em"),
          (c.style.verticalAlign = -m.depth + "em");
      }
      return m;
    }
    function wt(e) {
    ...
    var kt = (function () {
          ...
          (t.toMarkup = function () {
            ...
            for (var t in this.attributes)
              Object.prototype.hasOwnProperty.call(this.attributes, t) &&
                ...
                (e += '"'));
            this.classes.length > 0 &&
              (e += ' class ="' + l.escape(z(this.classes)) + '"'),
              (e += ">");
            for (var r = 0; r < this.children.length; r++)
              e += this.children[r].toMarkup();
            return (e += "</" + this.type + ">");
      ...
      Tt = function (e, t) {
        ...
        return l.contains(["\\imath", "\\jmath"], a)
          ? null
          : (X[n][a] && X[n][a].replace && (a = X[n][a].replace),
            V(a, je.fontMap[r].fontName, n) ? je.fontMap[r].variant : null);
      },
      Bt = function (e, t, r) {
        if (1 === e.length) {
          var n = Nt(e[0], t);
    ...
    function Ct(e, t, r, n, a) {
      ...
      i =
        1 === o.length &&
        o[0] instanceof kt &&
        l.contains(["mrow", "mtable"], o[0].type)
          ? o[0]
          : new Mt.MathNode("mrow", o);
    ...
    var It = function (e) {
      ...
      Ot = function (e, t, r) {
        ...
        if ("html" === r.output) {
          var i = xt(e, a);
          n = je.makeSpan(["katex"], [i]);
        } else {
          var o = Ct(e, t, a, r.displayMode, !1),
            s = xt(e, a);
          n = je.makeSpan(["katex"], [o, s]);
        }
        return Rt(n, r);
      },
      Et = {
      ...
      Lt = function (e, t, r, n, a) {
        ...
        if (/fbox|color|angl/.test(t)) {
          if (((i = je.makeSpan(["stretchy", t], [], a)), "fbox" === t)) {
          ...
          var h = new O(l, { width: "100%", height: o + "em" });
          i = je.makeSvgSpan([], [h], a);
        }
        return (i.height = o), (i.style.height = o + "em"), i;
      },
      Dt = function (e) {
        var t = new Mt.MathNode("mo", [
          new Mt.TextNode(Et[e.replace(/^\\/, "")]),
        ]);
      ...
      Pt = function (e, t) {
        var r = (function () {
            var r = 4e5,
              n = e.label.substr(1);
            if (
              l.contains(["widehat", "widecheck", "widetilde", "utilde"], n)
            ) {
              var a,
                i,
                o,
    ...
    var Ut = function (e, t) {
        ...
        e && "supsub" === e.type
          ? ((r = (n = Ft(e.base, "accent")).base),
            ...
            (e.base = n))
          : (r = (n = Ft(e, "accent")).base);
        var i = bt(r, t.havingCrampedStyle()),
          o = 0;
        if (n.isShifty && l.isCharacterBox(r)) {
          var s = l.getBaseElem(r);
          o = L(bt(s, t.havingCrampedStyle())).skew;
        }
        var h,
          m = Math.min(i.height, t.fontMetrics().xHeight);
        if (n.isStretchy)
          (h = Pt(n, t)),
            (h = je.makeVList(
              {
          ...
          var c, u;
          "\\vec" === n.label
            ? ((c = je.staticSvg("vec", t)), (u = je.svgData.vec[1]))
            : (((c = L(
                (c = je.makeOrd({ mode: n.mode, text: n.label }, t, "textord"))
              )).italic = 0),
              (u = c.width)),
            (h = je.makeSpan(["accent-body"], [c]));
        ...
        var f = je.makeSpan(["mord", "accent"], [h], t);
        return a
          ? ((a.children[0] = f),
      ...
      Yt = function (e, t) {
        var r = e.isStretchy
            ? Dt(e.label)
            : new Mt.MathNode("mo", [zt(e.label, e.mode)]),
          n = new Mt.MathNode("mover", [Nt(e.base, t), r]);
    ...
    nt({
      ...
      nt({
        ...
        htmlBuilder: function (e, t) {
          ...
          return je.makeSpan(["mord", "accentunder"], [i], t);
        },
        mathmlBuilder: function (e, t) {
          var r = Dt(e.label),
            n = new Mt.MathNode("munder", [Nt(e.base, t), r]);
    ...
    nt({
      ...
      htmlBuilder: function (e, t) {
        var r,
          ...
          i = je.wrapFragment(bt(e.body, a, t), t),
          o = "\\x" === e.label.slice(0, 2) ? "x" : "cd";
        i.classes.push(o + "-arrow-pad"),
          e.below &&
            ((a = t.havingStyle(n.sub())),
            (r = je.wrapFragment(bt(e.below, a, t), t)).classes.push(
              o + "-arrow-pad"
            ));
        var s,
          l = Pt(e, t),
        ...
        if (
          ((i.depth > 0.25 || "\\xleftequilibrium" === e.label) &&
            (m -= i.depth),
          r)
        ) {
          var c =
      ...
      mathmlBuilder: function (e, t) {
        ...
        if (
          ...
          var a = Xt(Nt(e.body, t));
          if (e.below) {
            var i = Xt(Nt(e.below, t));
            r = new Mt.MathNode("munderover", [n, i, a]);
          } else r = new Mt.MathNode("mover", [n, a]);
        } else if (e.below) {
          var o = Xt(Nt(e.below, t));
          r = new Mt.MathNode("munder", [n, o]);
        } else (r = Xt()), (r = new Mt.MathNode("mover", [n, r]));
        return r;
      },
    });
    var _t = {
    ...
    nt({
      ...
      htmlBuilder: function (e, t) {
        var r = t.havingStyle(t.style.sup()),
          n = je.wrapFragment(bt(e.label, r, t), t);
        return (
          n.classes.push("cd-label-" + e.side),
          (n.style.bottom = 0.8 - n.depth + "em"),
          (n.height = 0),
          (n.depth = 0),
          n
        );
      ...
      mathmlBuilder: function (e, t) {
        var r = new Mt.MathNode("mrow", [Nt(e.label, t)]);
        return (
          (r = new Mt.MathNode("mpadded", [r])).setAttribute("width", "0"),
          "left" === e.side && r.setAttribute("lspace", "-1width"),
          r.setAttribute("voffset", "0.7em"),
          (r = new Mt.MathNode("mstyle", [r])).setAttribute(
            "displaystyle",
            "false"
          ),
      ...
      nt({
        ...
        htmlBuilder: function (e, t) {
          var r = je.wrapFragment(bt(e.fragment, t), t);
          return r.classes.push("cd-vert-arrow"), r;
        },
        mathmlBuilder: function (e, t) {
          return new Mt.MathNode("mrow", [Nt(e.fragment, t)]);
        },
      }),
      nt({
        type: "textord",
        ...
        handler: function (e, t) {
          for (
            var r = e.parser, a = Ft(t[0], "ordgroup").body, i = "", o = 0;
            o < a.length;
            o++
          ) {
            i += Ft(a[o], "textord").text;
          }
          var s = parseInt(i);
    ...
    nt({
      ...
      handler: function (e, t) {
        var r = e.parser,
          ...
          a = t[1];
        return { type: "color", mode: r.mode, color: n, body: ot(a) };
      },
      htmlBuilder: Zt,
      mathmlBuilder: Kt,
    }),
      ...
      nt({
        ...
        handler: function (e, t, r) {
          ...
          return {
            ...
            mode: n.mode,
            newLine: i,
            size: a && Ft(a, "size").value,
          };
        },
        htmlBuilder: function (e, t) {
          var r = je.makeSpan(["mspace"], [], t);
          return (
            e.newLine &&
              (r.classes.push("newline"),
              e.size && (r.style.marginTop = Le(e.size, t) + "em")),
            r
          );
        },
        mathmlBuilder: function (e, t) {
          ...
          return (
            e.newLine &&
              ...
              e.size && r.setAttribute("height", Le(e.size, t) + "em")),
            r
          );
        },
      });
      ...
      nt({
        ...
        handler: function (e) {
          ...
          return (
            o && h.unshift(o),
            ("\\edef" !== r && "\\xdef" !== r) ||
              (h = t.gullet.expandTokens(h)).reverse(),
            t.gullet.macros.set(
              i,
    ...
    var tr = function (e, t, r) {
      ...
      rr = function (e, t, r, n) {
        var a = r.havingBaseStyle(t),
          i = je.makeSpan(n.concat(a.sizingClasses(r)), [e], r),
          o = a.sizeMultiplier / r.sizeMultiplier;
        return (
          (i.height *= o), (i.depth *= o), (i.maxFontSize = a.sizeMultiplier), i
        );
      },
      nr = function (e, t, r) {
      ...
      ar = function (e, t, r, n, a, i) {
        var o = (function (e, t, r, n) {
            return je.makeSymbol(e, "Size" + t + "-Regular", r, n);
          })(e, t, a, n),
          s = rr(
            je.makeSpan(["delimsizing", "size" + t], [o], n),
            b.TEXT,
            n,
            i
          );
        return r && nr(s, n, b.TEXT), s;
      },
      ir = function (e, t, r) {
        var n;
        return (
          (n = "Size1-Regular" === t ? "delim-size1" : "delim-size4"),
          {
            ...
            elem: je.makeSpan(
              ["delimsizinginner", n],
              [je.makeSpan([], [je.makeSymbol(e, t, r)])]
            ),
          }
        );
      },
      or = function (e, t, r) {
        var n = D["Size4-Regular"][e.charCodeAt(0)]
            ? D["Size4-Regular"][e.charCodeAt(0)][4].toFixed(3)
            : D["Size1-Regular"][e.charCodeAt(0)][4].toFixed(3),
          a = new E(
            "inner",
            (function (e, t) {
              switch (e) {
      ...
      mr = function (e, t, r, n, a, i) {
        ...
        var z = S / 2 - M,
          A = [];
        if ((A.push(ir(m, c, a)), A.push(sr), null === s)) {
          var T = S - p - v + 0.016;
          A.push(or(h, T, n));
        } else {
          var B = (S - p - v - y) / 2 + 0.016;
          A.push(or(h, B, n)),
            A.push(sr),
            A.push(ir(s, c, a)),
            A.push(sr),
        ...
        A.push(sr), A.push(ir(o, c, a));
        var q = n.havingBaseStyle(b.TEXT),
          N = je.makeVList(
            { positionType: "bottom", positionData: z, children: A },
            q
          );
        return rr(je.makeSpan(["delimsizing", "mult"], [N], q), b.TEXT, n, i);
      },
      cr = 0.08,
      ur = function (e, t, r, n, a) {
        ...
        return je.makeSvgSpan(["hide-tail"], [s], a);
      },
      pr = [
        "(",
        "\\lparen",
      ...
      kr = function (e, t, r, n, a, i) {
        ...
        "<" === e || "\\lt" === e || "\u27e8" === e
          ? (e = "\\langle")
          : (">" !== e && "\\gt" !== e && "\u27e9" !== e) || (e = "\\rangle"),
          (o = l.contains(fr, e) ? vr : l.contains(pr, e) ? yr : br);
        var s = wr(e, t, o, n);
        return "small" === s.type
          ? (function (e, t, r, n, a, i) {
              var o = je.makeSymbol(e, "Main-Regular", a, n),
                s = rr(o, t, n, i);
              return r && nr(s, n, t), s;
            })(e, s.style, r, n, a, i)
          : "large" === s.type
      ...
      Sr = function (e, t) {
        var r,
          ...
          i = wr("\\surd", e * a.sizeMultiplier, yr, a),
          o = a.sizeMultiplier,
          s = Math.max(
            0,
        ...
        return (
          "small" === i.type
            ...
            ? ((m = 1080 * gr[i.size]),
              (h = (gr[i.size] + s) / o),
              (l = (gr[i.size] + s + cr) / o),
              ((r = ur("sqrtSize" + i.size, l, m, s, t)).style.minWidth =
                "1.02em"),
              (n = 1 / o))
            : ((l = e + s + cr),
              (h = e + s),
              (m = Math.floor(1e3 * e + s) + 80),
              ((r = ur("sqrtTall", l, m, s, t)).style.minWidth = "0.742em"),
              (n = 1.056)),
          (r.height = h),
          (r.style.height = l + "em"),
          {
      ...
      Mr = function (e, t, r, a, i) {
        if (
          ("<" === e || "\\lt" === e || "\u27e8" === e
            ? (e = "\\langle")
            : (">" !== e && "\\gt" !== e && "\u27e9" !== e) || (e = "\\rangle"),
          l.contains(pr, e) || l.contains(fr, e))
        )
          return ar(e, t, !1, r, a, i);
        if (l.contains(dr, e)) return mr(e, gr[t], !1, r, a, i);
    ...
    nt({
      ...
      handler: function (e, t) {
        ...
        return {
          type: "delimsizing",
          mode: e.parser.mode,
          size: Br[e.funcName].size,
          mclass: Br[e.funcName].mclass,
          delim: r.text,
        };
      },
      htmlBuilder: function (e, t) {
        return "." === e.delim
          ? je.makeSpan([e.mclass])
          : Mr(e.delim, e.size, t, e.mode, [e.mclass]);
      },
      mathmlBuilder: function (e) {
        ...
        return (
          ...
          r.setAttribute("minsize", zr[e.size] + "em"),
          r.setAttribute("maxsize", zr[e.size] + "em"),
          r
        );
      },
    }),
        ...
        htmlBuilder: function (e, t) {
          ...
          if (
            ...
            (r =
              "." === e.left
                ? vt(t, ["mopen"])
                : Tr(e.left, i, o, t, e.mode, ["mopen"])),
            a.unshift(r),
            s)
          )
            for (var h = 1; h < a.length; h++) {
              var m = a[h].isMiddle;
              m && (a[h] = Tr(m.delim, i, o, m.options, e.mode, []));
            }
          if ("." === e.right) n = vt(t, ["mclose"]);
          else {
            var c = e.rightColor ? t.withColor(e.rightColor) : t;
            n = Tr(e.right, i, o, c, e.mode, ["mclose"]);
          }
          return a.push(n), je.makeSpan(["minner"], a, t);
        },
        mathmlBuilder: function (e, t) {
          Cr(e);
          var r = Bt(e.body, t);
    ...
    var Ir = function (e, t) {
        var r,
          n,
          a,
          i = je.wrapFragment(bt(e.body, t), t),
          o = e.label.substr(1),
          s = t.sizeMultiplier,
          h = 0,
          m = l.isCharacterBox(e.body);
        if ("sout" === o)
          ((r = je.makeSpan(["stretchy", "sout"])).height =
            t.fontMetrics().defaultRuleThickness / s),
            (h = -0.5 * t.fontMetrics().xHeight);
        else if ("phase" === o) {
          var c = Le({ number: 0.6, unit: "pt" }, t),
            u = Le({ number: 0.35, unit: "ex" }, t);
          ...
          ((r = je.makeSvgSpan(["hide-tail"], [g], t)).style.height = p + "em"),
            (h = i.depth + c + u);
        } else {
          /cancel/.test(o)
          ...
          /box/.test(o)
            ...
            /fbox|boxed|fcolorbox/.test(o)
              ? ((r.style.borderStyle = "solid"),
                (r.style.borderWidth = y + "em"))
              : "angl" === o &&
                0.049 !== y &&
                ((r.style.borderTopWidth = y + "em"),
                (r.style.borderRightWidth = y + "em")),
            (h = i.depth + b),
            e.backgroundColor &&
        ...
        return (
          ...
          /cancel/.test(o) && !m
            ? je.makeSpan(["mord", "cancel-lap"], [a], t)
            : je.makeSpan(["mord"], [a], t)
        );
      },
      Rr = function (e, t) {
        var r = 0,
        ...
        switch (e.label) {
          ...
          case "\\colorbox":
            if (
              ...
              n.setAttribute(
                "style",
                "border: " + a + "em solid " + String(e.borderColor)
              );
            }
            break;
          case "\\xcancel":
    ...
    function Dr(e, t, r) {
      ...
      if (
        (e.gullet.beginGroup(),
        m || e.gullet.macros.set("\\cr", "\\\\\\relax"),
        !s)
      ) {
      ...
      var f = [],
        ...
        b = [];
      for (b.push(Hr(e)); ; ) {
        var y = e.parseExpression(!1, m ? "\\end" : "\\\\");
        e.gullet.endGroup(),
          e.gullet.beginGroup(),
          (y = { type: "ordgroup", mode: e.mode, body: y }),
          r && (y = { type: "styling", mode: e.mode, style: r, body: [y] }),
          f.push(y);
        var x = e.fetch().text;
        if ("&" === x) {
          if (u && f.length === u) {
          ...
          e.consume();
          var w = void 0;
          " " !== e.gullet.future().text && (w = e.parseSizeGroup(!0)),
            v.push(w ? w.value : null),
            b.push(Hr(e)),
            (f = []),
            g.push(f);
        }
    ...
    var Fr = function (e, t) {
        ...
        function w(e) {
          for (var t = 0; t < e.length; ++t)
            t > 0 && (x += 0.25), m.push({ pos: x, isDashed: e[t] });
        }
        ...
        var q,
          N,
          C = x / 2 + t.fontMetrics().axisHeight,
          I = e.cols || [],
          R = [],
          O = [];
        if (e.addEqnNum)
          for (r = 0; r < i; ++r) {
            var E = h[r],
              H = E.pos - C,
              L = je.makeSpan(["eqn-num"], [], t);
            (L.depth = E.depth),
              (L.height = E.height),
              O.push({ type: "elem", elem: L, shift: H });
          }
        for (a = 0, N = 0; a < s || N < I.length; ++a, ++N) {
          for (var D = I[N] || {}, P = !0; "separator" === D.type; ) {
            if (
              (P ||
                (((q = je.makeSpan(["arraycolsep"], [])).style.width =
            ...
            var F = "|" === D.separator ? "solid" : "dashed",
              V = je.makeSpan(["vertical-separator"], [], t);
            (V.style.height = x + "em"),
              (V.style.borderRightWidth = c + "em"),
              (V.style.borderRightStyle = F),
              (V.style.margin = "0 -" + c / 2 + "em"),
              (V.style.verticalAlign = -(x - C) + "em"),
              R.push(V),
              (D = I[++N] || {}),
              (P = !1);
          }
          if (!(a >= s)) {
            ...
            (a > 0 || e.hskipBeforeAndAfter) &&
              0 !== (G = l.deflt(D.pregap, p)) &&
              (((q = je.makeSpan(["arraycolsep"], [])).style.width = G + "em"),
              R.push(q));
            var U = [];
            for (r = 0; r < i; ++r) {
              var Y = h[r],
              ...
              if (W) {
                ...
                (W.depth = Y.depth),
                  (W.height = Y.height),
                  U.push({ type: "elem", elem: W, shift: X });
              }
            }
            (U = je.makeVList(
              ...
              (U = je.makeSpan(["col-align-" + (D.align || "c")], [U])),
              R.push(U),
              (a < s - 1 || e.hskipBeforeAndAfter) &&
                0 !== (G = l.deflt(D.postgap, p)) &&
                (((q = je.makeSpan(["arraycolsep"], [])).style.width =
                  G + "em"),
                R.push(q));
          }
        }
        if (((h = je.makeSpan(["mtable"], R)), m.length > 0)) {
          for (
            var _ = je.makeLineSpan("hline", t, c),
              j = je.makeLineSpan("hdashline", t, c),
            ...
            var Z = m.pop(),
              K = Z.pos - C;
            Z.isDashed
              ? $.push({ type: "elem", elem: j, shift: K })
              : $.push({ type: "elem", elem: _, shift: K });
          }
          h = je.makeVList({ positionType: "individualShift", children: $ }, t);
        }
        if (e.addEqnNum) {
          var J = je.makeVList(
          ...
          return (J = je.makeSpan(["tag"], [J], t)), je.makeFragment([h, J]);
        }
        return je.makeSpan(["mord"], [h], t);
      },
      ...
      Gr = function (e, t) {
        for (
          var r = [],
            ...
            a = new Mt.MathNode("mtd", [], ["mml-eqn-num"]),
            i = 0;
          i < e.body.length;
          i++
        ) {
          for (var o = e.body[i], s = [], l = 0; l < o.length; l++)
            s.push(new Mt.MathNode("mtd", [Nt(o[l], t)]));
          e.addEqnNum &&
            (s.unshift(n), s.push(n), e.leqno ? s.unshift(a) : s.push(a)),
            r.push(new Mt.MathNode("mtr", s));
        }
        ...
        if (e.cols && e.cols.length > 0) {
          ...
          "separator" === p[0].type && ((c += "top "), (g = 1)),
            "separator" === p[p.length - 1].type &&
              ((c += "bottom "), (v -= 1));
          for (var b = g; b < v; b++)
            "align" === p[b].type
              ? ((u += Vr[p[b].align]), f && (d += "none "), (f = !0))
              : "separator" === p[b].type &&
                f &&
                ((d += "|" === p[b].separator ? "solid " : "dashed "),
                (f = !1));
        ...
        return (
          ...
          "" !== c &&
            (h = new Mt.MathNode("menclose", [h])).setAttribute(
              "notation",
              c.trim()
            ),
          e.arraystretch &&
            e.arraystretch < 1 &&
            (h = new Mt.MathNode("mstyle", [h])).setAttribute(
              "scriptlevel",
              "1"
            ),
          h
      ...
      Ur = function (e, t) {
        ...
        o.body.forEach(function (e) {
          for (var t = 1; t < e.length; t += 2) {
            var a = Ft(e[t], "styling");
            Ft(a.body[0], "ordgroup").body.unshift(l);
          }
    ...
    Er({
      ...
      props: { numArgs: 1 },
      handler: function (e, t) {
        var r = (Gt(t[0]) ? [t[0]] : Ft(t[0], "ordgroup").body).map(function (
            e
          ) {
            var t = Vt(e).text;
        ...
        return Dr(e.parser, a, Pr(e.envName));
      },
      htmlBuilder: Fr,
      mathmlBuilder: Gr,
    }),
      Er({
        ...
        handler: function (e) {
          ...
          var o = Dr(e.parser, a, Pr(e.envName));
          return (
            (o.cols = new Array(o.body[0].length).fill({
              type: "align",
              align: r,
            })),
            t
      ...
      Er({
        ...
        props: { numArgs: 0 },
        handler: function (e) {
          var t = Dr(e.parser, { arraystretch: 0.5 }, "script");
      ...
      Er({
        ...
        handler: function (e, t) {
          ...
          if (
            (a = Dr(e.parser, a, "script")).body.length > 0 &&
            a.body[0].length > 1
          )
            throw new n("{subarray} can contain only one column");
          return a;
      ...
      Er({
        ...
        props: { numArgs: 0 },
        handler: function (e) {
          l.contains(["gather", "gather*"], e.envName) && Lr(e);
          var t = {
    ...
    nt({
      ...
      handler: function (e, t) {
        ...
        for (var o = "", s = 0; s < i.body.length; ++s)
          o += Ft(i.body[s], "textord").text;
        if ("\\begin" === a) {
          if (!Yr.hasOwnProperty(o))
          ...
          if (f.name !== o)
            throw new n(
              "Mismatch: \\begin{" + o + "} matched by \\end{" + f.name + "}",
              d
            );
          return p;
        }
    ...
    function _r(e, t) {
      var r,
        n = Bt(e.body, t);
      return "minner" === e.mclass
        ? Mt.newDocumentFragment(n)
        : ("mord" === e.mclass
            ? e.isCharacterBox
              ? ((r = n[0]).type = "mi")
              : (r = new Mt.MathNode("mi", n))
            : (e.isCharacterBox
                ? ((r = n[0]).type = "mo")
                : (r = new Mt.MathNode("mo", n)),
              "mbin" === e.mclass
      ...
      Qr = function (e, t) {
        ...
        if (
          (e.hasBarLine
            ? (e.barSize
                ? ((m = Le(e.barSize, t)),
                  (h = je.makeLineSpan("frac-line", t, m)))
                : (h = je.makeLineSpan("frac-line", t)),
              (m = h.height),
              (c = h.height))
            : ((h = null), (m = 0), (c = t.fontMetrics().defaultRuleThickness)),
          n.size === b.DISPLAY.size || "display" === e.size
          ...
          u - o.depth - (w + 0.5 * m) < p &&
            (u += p - (u - o.depth - (w + 0.5 * m))),
            w - 0.5 * m - (x.height - d) < p &&
              (d += p - (w - 0.5 * m - (x.height - d)));
          var k = -(w - 0.5 * m);
          f = je.makeVList(
            {
              positionType: "individualShift",
        ...
        return (
          ...
          (g =
            n.size === b.DISPLAY.size
              ? t.fontMetrics().delim1
              : n.size === b.SCRIPTSCRIPT.size
              ? t.havingStyle(b.SCRIPT).fontMetrics().delim2
              : t.fontMetrics().delim2),
          (v =
            null == e.leftDelim
              ? vt(t, ["mopen"])
              : Ar(e.leftDelim, g, !0, t.havingStyle(n), e.mode, ["mopen"])),
          (y = e.continued
            ? je.makeSpan([])
            : null == e.rightDelim
            ? vt(t, ["mclose"])
            : Ar(e.rightDelim, g, !0, t.havingStyle(n), e.mode, ["mclose"])),
          je.makeSpan(
            ["mord"].concat(r.sizingClasses(t)),
            [v, je.makeSpan(["mfrac"], [f]), y],
            t
          )
        );
      },
      en = function (e, t) {
        var r = new Mt.MathNode("mfrac", [Nt(e.numer, t), Nt(e.denom, t)]);
        if (e.hasBarLine) {
          if (e.barSize) {
    ...
    var tn = ["display", "text", "script", "scriptscript"],
      rn = function (e) {
        var t = null;
    ...
    nt({
      ...
      handler: function (e, t) {
        var r,
          ...
          i = t[5],
          o = it(t[0]),
          s = "atom" === o.type && "open" === o.family ? rn(o.text) : null,
          l = it(t[1]),
          h = "atom" === l.type && "close" === l.family ? rn(l.text) : null,
          m = Ft(t[2], "size"),
          c = null;
        ...
        } else (p = Ft(p, "textord")), (u = tn[Number(p.text)]);
        return {
          type: "genfrac",
          mode: n.mode,
          numer: a,
    ...
    var nn = function (e, t) {
      ...
      "supsub" === e.type
        ? ((r = e.sup
            ? bt(e.sup, t.havingStyle(a.sup()), t)
            : bt(e.sub, t.havingStyle(a.sub()), t)),
          (n = Ft(e.base, "horizBrace")))
        : (n = Ft(e, "horizBrace"));
      var i,
        o = bt(n.base, t.havingBaseStyle(b.DISPLAY)),
        s = Pt(n, t);
      if (
        (n.isOver
          ? (i = je.makeVList(
        ...
        var l = je.makeSpan(["mord", n.isOver ? "mover" : "munder"], [i], t);
        i = n.isOver
          ? je.makeVList(
              {
                positionType: "firstBaseline",
      ...
      return je.makeSpan(["mord", n.isOver ? "mover" : "munder"], [i], t);
    };
    nt({
      type: "horizBrace",
      ...
      mathmlBuilder: function (e, t) {
        var r = Dt(e.label);
        return new Mt.MathNode(e.isOver ? "mover" : "munder", [
          Nt(e.base, t),
          r,
        ]);
      },
      ...
      nt({
        ...
        handler: function (e, t) {
          ...
          return r.settings.isTrusted({ command: "\\href", url: a })
            ? { type: "href", mode: r.mode, href: a, body: ot(n) }
            : r.formatUnsupportedCmd("\\href");
        },
        htmlBuilder: function (e, t) {
          var r = ut(e.body, t, !1);
          return je.makeAnchor(e.href, [], r, t);
        },
        mathmlBuilder: function (e, t) {
          var r = qt(e.body, t);
          return (
            r instanceof kt || (r = new kt("mrow", [r])),
      ...
      nt({
        ...
        handler: function (e, t) {
          ...
          return { type: "href", mode: r.mode, href: n, body: ot(s) };
        },
      }),
      nt({
        type: "hbox",
        ...
        handler: function (e, t) {
          return { type: "hbox", mode: e.parser.mode, body: ot(t[0]) };
        },
        htmlBuilder: function (e, t) {
          var r = ut(e.body, t, !1);
          return je.makeFragment(r);
      ...
      nt({
        ...
        handler: function (e, t) {
          ...
          return a.settings.isTrusted(r)
            ? { type: "html", mode: a.mode, attributes: l, body: ot(s) }
        ...
        htmlBuilder: function (e, t) {
          var r = ut(e.body, t, !1),
            n = ["enclosing"];
          e.attributes.class &&
            n.push.apply(n, e.attributes.class.trim().split(/\s+/));
          var a = je.makeSpan(n, r, t);
    ...
    nt({
      ...
      handler: function (e, t, r) {
        ...
        if (r[0])
          for (
            var h = Ft(r[0], "raw").string.split(","), m = 0;
            m < h.length;
            m++
          ) {
            var c = h[m].split("=");
      ...
      htmlBuilder: function (e, t) {
        ...
        e.totalheight.number > 0 &&
          ((n = Le(e.totalheight, t) - r), (n = Number(n.toFixed(2))));
        var a = 0;
      ...
      mathmlBuilder: function (e, t) {
        ...
        if (
          (e.totalheight.number > 0 &&
            ((a = (a = Le(e.totalheight, t) - n).toFixed(2)),
      ...
      nt({
        ...
        htmlBuilder: function (e, t) {
          return je.makeGlue(e.dimension, t);
        },
        mathmlBuilder: function (e, t) {
      ...
      nt({
        ...
        htmlBuilder: function (e, t) {
          var r;
          "clap" === e.alignment
            ? ((r = je.makeSpan([], [bt(e.body, t)])),
              (r = je.makeSpan(["inner"], [r], t)))
            : (r = je.makeSpan(["inner"], [bt(e.body, t)]));
          var n = je.makeSpan(["fix"], []),
            a = je.makeSpan([e.alignment], [r, n], t),
            i = je.makeSpan(["strut"]);
          return (
            (i.style.height = a.height + a.depth + "em"),
            (i.style.verticalAlign = -a.depth + "em"),
            a.children.unshift(i),
            (a = je.makeSpan(["thinbox"], [a], t)),
            je.makeSpan(["mord", "vbox"], [a], t)
          );
        },
        mathmlBuilder: function (e, t) {
          var r = new Mt.MathNode("mpadded", [Nt(e.body, t)]);
          if ("rlap" !== e.alignment) {
    ...
    var sn = function (e, t, r, n, a, i, o) {
        var s, l, h;
        if (((e = je.makeSpan([], [e])), t)) {
          var m = bt(t, n.havingStyle(a.sup()), n);
          l = {
            elem: m,
            kern: Math.max(
              n.fontMetrics().bigOpSpacing1,
              n.fontMetrics().bigOpSpacing3 - m.depth
            ),
          };
        }
        if (r) {
          var c = bt(r, n.havingStyle(a.sub()), n);
          s = {
            elem: c,
            kern: Math.max(
              n.fontMetrics().bigOpSpacing2,
              n.fontMetrics().bigOpSpacing4 - c.height
            ),
          };
        }
        if (l && s) {
        ...
        return je.makeSpan(["mop", "op-limits"], [h], n);
      },
      ln = ["\\smallint"],
      hn = function (e, t) {
        var r,
          ...
          i = !1;
        "supsub" === e.type
          ? ((r = e.sup), (n = e.sub), (a = Ft(e.base, "op")), (i = !0))
          : (a = Ft(e, "op"));
        var o,
          s = t.style,
          h = !1;
        if (
          ...
          if (
            (("\\oiint" !== a.name && "\\oiiint" !== a.name) ||
              ((c = a.name.substr(1)),
              (a.name = "oiint" === c ? "\\iint" : "\\iiint")),
            (o = je.makeSymbol(a.name, m, "math", t, [
              "mop",
              "op-symbol",
              h ? "large-op" : "small-op",
            ])),
          ...
          var d = ut(a.body, t, !0);
          1 === d.length && d[0] instanceof R
            ? ((o = d[0]).classes[0] = "mop")
            : (o = je.makeSpan(["mop"], d, t));
        } else {
          for (var f = [], g = 1; g < a.name.length; g++)
            f.push(je.mathsym(a.name[g], a.mode, t));
          o = je.makeSpan(["mop"], f, t);
        }
        var v = 0,
          y = 0;
        return (
          (o instanceof R || "\\oiint" === a.name || "\\oiiint" === a.name) &&
            !a.suppressBaseShift &&
            ((v = (o.height - o.depth) / 2 - t.fontMetrics().axisHeight),
            (y = o.italic)),
          i
            ? sn(o, r, n, t, s, y, v)
            : (v && ((o.style.position = "relative"), (o.style.top = v + "em")),
              o)
        );
      },
      mn = function (e, t) {
        var r;
        if (e.symbol)
          (r = new kt("mo", [zt(e.name, e.mode)])),
            l.contains(ln, e.name) && r.setAttribute("largeop", "false");
    ...
    fn("\\noexpand", function (e) {
      ...
      fn("\\@ifstar", "\\@ifnextchar *{\\@firstoftwo{#1}}"),
      fn("\\TextOrMath", function (e) {
    ...
    fn("\\newcommand", function (e) {
      ...
      fn("\\renewcommand", function (e) {
        return vn(e, !0, !1);
      }),
      fn("\\providecommand", function (e) {
        return vn(e, !0, !0);
      }),
      fn("\\message", function (e) {
      ...
      fn("\\show", function (e) {
        var t = e.popToken(),
          r = t.text;
        return console.log(t, e.macros.get(r), En[r], X.math[r], X.text[r]), "";
      }),
      fn("\\bgroup", "{"),
      fn("\\egroup", "}"),
      fn("~", "\\nobreakspace"),
      ...
      fn("\\aa", "\\r a"),
      fn("\\AA", "\\r A"),
      fn("\\textcopyright", "\\html@mathml{\\textcircled{c}}{\\char`\xa9}"),
      fn(
        "\\copyright",
      ...
      fn("\\Bbbk", "\\Bbb{k}"),
      fn("\xb7", "\\cdotp"),
      fn("\\llap", "\\mathllap{\\textrm{#1}}"),
      fn("\\rlap", "\\mathrlap{\\textrm{#1}}"),
      fn("\\clap", "\\mathclap{\\textrm{#1}}"),
      fn("\\mathstrut", "\\vphantom{(}"),
      fn("\\underbar", "\\underline{\\text{#1}}"),
      ...
      fn("\u231f", "\\lrcorner"),
      fn("\xa9", "\\copyright"),
      fn("\xae", "\\textregistered"),
      fn("\ufe0f", "\\textregistered"),
      fn("\\ulcorner", '\\html@mathml{\\@ulcorner}{\\mathop{\\char"231c}}'),
      fn("\\urcorner", '\\html@mathml{\\@urcorner}{\\mathop{\\char"231d}}'),
      fn("\\llcorner", '\\html@mathml{\\@llcorner}{\\mathop{\\char"231e}}'),
      fn("\\lrcorner", '\\html@mathml{\\@lrcorner}{\\mathop{\\char"231f}}'),
      fn("\\vdots", "\\mathord{\\varvdots\\rule{0pt}{15pt}}"),
      fn("\u22ee", "\\vdots"),
      fn("\\varGamma", "\\mathit{\\Gamma}"),
      fn("\\varDelta", "\\mathit{\\Delta}"),
      fn("\\varTheta", "\\mathit{\\Theta}"),
      fn("\\varLambda", "\\mathit{\\Lambda}"),
      fn("\\varXi", "\\mathit{\\Xi}"),
      fn("\\varPi", "\\mathit{\\Pi}"),
      fn("\\varSigma", "\\mathit{\\Sigma}"),
      fn("\\varUpsilon", "\\mathit{\\Upsilon}"),
      fn("\\varPhi", "\\mathit{\\Phi}"),
      fn("\\varPsi", "\\mathit{\\Psi}"),
      fn("\\varOmega", "\\mathit{\\Omega}"),
      fn("\\substack", "\\begin{subarray}{c}#1\\end{subarray}"),
      fn(
        "\\colon",
        "\\nobreak\\mskip2mu\\mathpunct{}\\mathchoice{\\mkern-3mu}{\\mkern-3mu}{}{}{:}\\mskip6mu"
      ),
      fn("\\boxed", "\\fbox{$\\displaystyle{#1}$}"),
      fn("\\iff", "\\DOTSB\\;\\Longleftrightarrow\\;"),
      fn("\\implies", "\\DOTSB\\;\\Longrightarrow\\;"),
      fn("\\impliedby", "\\DOTSB\\;\\Longleftarrow\\;");
    var bn = {
      ",": "\\dotsc",
      "\\not": "\\dotsb",
      "+": "\\dotsb",
    ...
    fn("\\dots", function (e) {
      ...
      return (
        r in bn
          ? (t = bn[r])
          : ("\\not" === r.substr(0, 4) ||
              (r in X.math && l.contains(["bin", "rel"], X.math[r].group))) &&
            (t = "\\dotsb"),
        t
      );
    });
    ...
    fn("\\dotso", function (e) {
      ...
      fn("\\DOTSB", "\\relax"),
      fn("\\DOTSX", "\\relax"),
      fn("\\tmspace", "\\TextOrMath{\\kern#1#3}{\\mskip#1#2}\\relax"),
      fn("\\,", "\\tmspace+{3mu}{.1667em}"),
      fn("\\thinspace", "\\,"),
      fn("\\>", "\\mskip{4mu}"),
      fn("\\:", "\\tmspace+{4mu}{.2222em}"),
      fn("\\medspace", "\\:"),
      fn("\\;", "\\tmspace+{5mu}{.2777em}"),
      fn("\\thickspace", "\\;"),
      fn("\\!", "\\tmspace-{3mu}{.1667em}"),
      fn("\\negthinspace", "\\!"),
      ...
      fn("\\enspace", "\\kern.5em "),
      fn("\\enskip", "\\hskip.5em\\relax"),
      fn("\\quad", "\\hskip1em\\relax"),
      fn("\\qquad", "\\hskip2em\\relax"),
      fn("\\tag", "\\@ifstar\\tag@literal\\tag@paren"),
      fn("\\tag@paren", "\\tag@literal{({#1})}"),
      fn("\\tag@literal", function (e) {
    ...
    fn(
      ...
      fn("\\hspace", "\\@ifstar\\@hspacer\\@hspace"),
      fn("\\@hspace", "\\hskip #1\\relax"),
      fn("\\@hspacer", "\\rule{0pt}{0pt}\\hskip #1\\relax"),
      fn("\\ordinarycolon", ":"),
      fn("\\vcentcolon", "\\mathrel{\\mathop\\ordinarycolon}"),
      fn(
        "\\dblcolon",
      ...
      fn("\u2a74", "\\Coloneqq"),
      fn("\\ratio", "\\vcentcolon"),
      fn("\\coloncolon", "\\dblcolon"),
      fn("\\colonequals", "\\coloneqq"),
      fn("\\coloncolonequals", "\\Coloneqq"),
      fn("\\equalscolon", "\\eqqcolon"),
      fn("\\equalscoloncolon", "\\Eqqcolon"),
      fn("\\colonminus", "\\coloneq"),
      fn("\\coloncolonminus", "\\Coloneq"),
      fn("\\minuscolon", "\\eqcolon"),
      fn("\\minuscoloncolon", "\\Eqcolon"),
      fn("\\coloncolonapprox", "\\Colonapprox"),
      fn("\\coloncolonsim", "\\Colonsim"),
      fn("\\simcolon", "\\mathrel{\\sim\\mathrel{\\mkern-1.2mu}\\vcentcolon}"),
      fn(
        "\\simcoloncolon",
      ...
      fn("\\notni", "\\html@mathml{\\not\\ni}{\\mathrel{\\char`\u220c}}"),
      fn("\\limsup", "\\DOTSB\\operatorname*{lim\\,sup}"),
      fn("\\liminf", "\\DOTSB\\operatorname*{lim\\,inf}"),
      fn("\\injlim", "\\DOTSB\\operatorname*{inj\\,lim}"),
      fn("\\projlim", "\\DOTSB\\operatorname*{proj\\,lim}"),
      fn("\\varlimsup", "\\DOTSB\\operatorname*{\\overline{lim}}"),
      fn("\\varliminf", "\\DOTSB\\operatorname*{\\underline{lim}}"),
      fn("\\varinjlim", "\\DOTSB\\operatorname*{\\underrightarrow{lim}}"),
      fn("\\varprojlim", "\\DOTSB\\operatorname*{\\underleftarrow{lim}}"),
      fn("\\gvertneqq", "\\html@mathml{\\@gvertneqq}{\u2269}"),
      fn("\\lvertneqq", "\\html@mathml{\\@lvertneqq}{\u2268}"),
      ...
      fn("\\varsubsetneq", "\\html@mathml{\\@varsubsetneq}{\u228a}"),
      fn("\\varsubsetneqq", "\\html@mathml{\\@varsubsetneqq}{\u2acb}"),
      fn("\\varsupsetneq", "\\html@mathml{\\@varsupsetneq}{\u228b}"),
      fn("\\varsupsetneqq", "\\html@mathml{\\@varsupsetneqq}{\u2acc}"),
      fn("\\imath", "\\html@mathml{\\@imath}{\u0131}"),
      fn("\\jmath", "\\html@mathml{\\@jmath}{\u0237}"),
      fn(
        "\\llbracket",
      ...
      fn("\\Complex", "\\mathbb{C}"),
      fn("\\Dagger", "\\ddagger"),
      fn("\\diamonds", "\\diamondsuit"),
      fn("\\empty", "\\emptyset"),
      fn("\\Epsilon", "\\mathrm{E}"),
      fn("\\Eta", "\\mathrm{H}"),
      fn("\\exist", "\\exists"),
      fn("\\harr", "\\leftrightarrow"),
      fn("\\hArr", "\\Leftrightarrow"),
      fn("\\Harr", "\\Leftrightarrow"),
      fn("\\hearts", "\\heartsuit"),
      fn("\\image", "\\Im"),
      ...
      fn("\\weierp", "\\wp"),
      fn("\\Zeta", "\\mathrm{Z}"),
      fn("\\argmin", "\\DOTSB\\operatorname*{arg\\,min}"),
      fn("\\argmax", "\\DOTSB\\operatorname*{arg\\,max}"),
      fn("\\plim", "\\DOTSB\\mathop{\\operatorname{plim}}\\limits"),
      fn("\\bra", "\\mathinner{\\langle{#1}|}"),
      fn("\\ket", "\\mathinner{|{#1}\\rangle}"),
      fn("\\braket", "\\mathinner{\\langle{#1}\\rangle}"),
      fn("\\Bra", "\\left\\langle#1\\right|"),
      fn("\\Ket", "\\left|#1\\right\\rangle"),
      fn("\\angln", "{\\angl n}"),
      fn("\\blue", "\\textcolor{##6495ed}{#1}"),
      fn("\\orange", "\\textcolor{##ffa500}{#1}"),
      fn("\\pink", "\\textcolor{##ff00af}{#1}"),
      fn("\\red", "\\textcolor{##df0030}{#1}"),
      fn("\\green", "\\textcolor{##28ae7b}{#1}"),
      fn("\\gray", "\\textcolor{gray}{#1}"),
      fn("\\purple", "\\textcolor{##9d38bd}{#1}"),
      fn("\\blueA", "\\textcolor{##ccfaff}{#1}"),
      fn("\\blueB", "\\textcolor{##80f6ff}{#1}"),
      fn("\\blueC", "\\textcolor{##63d9ea}{#1}"),
      fn("\\blueD", "\\textcolor{##11accd}{#1}"),
      fn("\\blueE", "\\textcolor{##0c7f99}{#1}"),
      fn("\\tealA", "\\textcolor{##94fff5}{#1}"),
      fn("\\tealB", "\\textcolor{##26edd5}{#1}"),
      fn("\\tealC", "\\textcolor{##01d1c1}{#1}"),
      fn("\\tealD", "\\textcolor{##01a995}{#1}"),
      fn("\\tealE", "\\textcolor{##208170}{#1}"),
      fn("\\greenA", "\\textcolor{##b6ffb0}{#1}"),
      fn("\\greenB", "\\textcolor{##8af281}{#1}"),
      fn("\\greenC", "\\textcolor{##74cf70}{#1}"),
      fn("\\greenD", "\\textcolor{##1fab54}{#1}"),
      fn("\\greenE", "\\textcolor{##0d923f}{#1}"),
      fn("\\goldA", "\\textcolor{##ffd0a9}{#1}"),
      fn("\\goldB", "\\textcolor{##ffbb71}{#1}"),
      fn("\\goldC", "\\textcolor{##ff9c39}{#1}"),
      fn("\\goldD", "\\textcolor{##e07d10}{#1}"),
      fn("\\goldE", "\\textcolor{##a75a05}{#1}"),
      fn("\\redA", "\\textcolor{##fca9a9}{#1}"),
      fn("\\redB", "\\textcolor{##ff8482}{#1}"),
      fn("\\redC", "\\textcolor{##f9685d}{#1}"),
      fn("\\redD", "\\textcolor{##e84d39}{#1}"),
      fn("\\redE", "\\textcolor{##bc2612}{#1}"),
      fn("\\maroonA", "\\textcolor{##ffbde0}{#1}"),
      fn("\\maroonB", "\\textcolor{##ff92c6}{#1}"),
      fn("\\maroonC", "\\textcolor{##ed5fa6}{#1}"),
      fn("\\maroonD", "\\textcolor{##ca337c}{#1}"),
      fn("\\maroonE", "\\textcolor{##9e034e}{#1}"),
      fn("\\purpleA", "\\textcolor{##ddd7ff}{#1}"),
      fn("\\purpleB", "\\textcolor{##c6b9fc}{#1}"),
      fn("\\purpleC", "\\textcolor{##aa87ff}{#1}"),
      fn("\\purpleD", "\\textcolor{##7854ab}{#1}"),
      fn("\\purpleE", "\\textcolor{##543b78}{#1}"),
      fn("\\mintA", "\\textcolor{##f5f9e8}{#1}"),
      fn("\\mintB", "\\textcolor{##edf2df}{#1}"),
      fn("\\mintC", "\\textcolor{##e0e5cc}{#1}"),
      fn("\\grayA", "\\textcolor{##f6f7f7}{#1}"),
      fn("\\grayB", "\\textcolor{##f0f1f2}{#1}"),
      fn("\\grayC", "\\textcolor{##e3e5e6}{#1}"),
      fn("\\grayD", "\\textcolor{##d6d8da}{#1}"),
      fn("\\grayE", "\\textcolor{##babec2}{#1}"),
      fn("\\grayF", "\\textcolor{##888d93}{#1}"),
      fn("\\grayG", "\\textcolor{##626569}{#1}"),
      fn("\\grayH", "\\textcolor{##3b3e40}{#1}"),
      fn("\\grayI", "\\textcolor{##21242c}{#1}"),
      fn("\\kaBlue", "\\textcolor{##314453}{#1}"),
      fn("\\kaGreen", "\\textcolor{##71B307}{#1}");
    var wn = function (e, t) {
      var r,
        n,
        a,
      ...
      if (
        ...
        i = je.makeSpan(["mop"], l, t);
      } else i = je.makeSpan(["mop"], [], t);
      return o ? sn(i, r, n, t, t.style, 0, 0) : i;
    };
    function kn(e, t, r) {
      for (
        var n = ut(e, t, !1), a = t.sizeMultiplier / r.sizeMultiplier, i = 0;
        i < n.length;
        i++
      ) {
    ...
    nt({
      ...
      mathmlBuilder: function (e, t) {
        for (
          var r = Bt(e.body, t.withFont("mathrm")), n = !0, a = 0;
          a < r.length;
          a++
        ) {
          var i = r[a];
          if (i instanceof Mt.SpaceNode);
          else if (i instanceof Mt.MathNode)
            switch (i.type) {
              case "mi":
              case "mn":
              case "ms":
              ...
              case "mo":
                var o = i.children[0];
                1 === i.children.length && o instanceof Mt.TextNode
                  ? (o.text = o.text
                      .replace(/\u2212/, "-")
                      .replace(/\u2217/, "*"))
                  : (n = !1);
        ...
        return e.parentIsSupSub
          ? new Mt.MathNode("mrow", [l, h])
          : Mt.newDocumentFragment([l, h]);
      },
    }),
      fn("\\operatorname", "\\@ifstar\\operatornamewithlimits\\operatorname@"),
      at({
        type: "ordgroup",
        htmlBuilder: function (e, t) {
          return e.semisimple
            ? je.makeFragment(ut(e.body, t, !1))
            : je.makeSpan(["mord"], ut(e.body, t, !0), t);
        },
        mathmlBuilder: function (e, t) {
      ...
      nt({
        ...
        htmlBuilder: function (e, t) {
          var r = bt(e.body, t.havingCrampedStyle()),
            n = je.makeLineSpan("overline-line", t),
          ...
          return je.makeSpan(["mord", "overline"], [i], t);
        },
        mathmlBuilder: function (e, t) {
          var r = new Mt.MathNode("mo", [new Mt.TextNode("\u203e")]);
          r.setAttribute("stretchy", "true");
          var n = new Mt.MathNode("mover", [Nt(e.body, t), r]);
          return n.setAttribute("accent", "true"), n;
        },
      }),
      nt({
        ...
        handler: function (e, t) {
          var r = e.parser,
            n = t[0];
          return { type: "phantom", mode: r.mode, body: ot(n) };
        },
        htmlBuilder: function (e, t) {
      ...
      nt({
        ...
        htmlBuilder: function (e, t) {
          var r = je.makeSpan([], [bt(e.body, t.withPhantom())]);
        ...
        mathmlBuilder: function (e, t) {
          ...
          return (
            a.setAttribute("height", "0px"), a.setAttribute("depth", "0px"), a
          );
        },
      }),
      nt({
        ...
        htmlBuilder: function (e, t) {
          var r = je.makeSpan(["inner"], [bt(e.body, t.withPhantom())]),
            n = je.makeSpan(["fix"], []);
          return je.makeSpan(["mord", "rlap"], [r, n], t);
        },
        mathmlBuilder: function (e, t) {
          var r = Bt(ot(e.body), t),
            n = new Mt.MathNode("mphantom", r),
      ...
      nt({
        ...
        htmlBuilder: function (e, t) {
          ...
          0 === r.height && (r.height = t.fontMetrics().xHeight),
            (r = je.wrapFragment(r, t));
          var n = t.fontMetrics().defaultRuleThickness,
            a = n;
          t.style.id < b.TEXT.id && (a = t.fontMetrics().xHeight);
          var i = n + a / 4,
          ...
          if (e.index) {
            var d = t.havingStyle(b.SCRIPTSCRIPT),
              f = bt(e.index, d, t),
              ...
              y = je.makeSpan(["root"], [v]);
            return je.makeSpan(["mord", "sqrt"], [y, p], t);
          }
          return je.makeSpan(["mord", "sqrt"], [p], t);
        },
        mathmlBuilder: function (e, t) {
          var r = e.body,
            n = e.index;
          return n
            ? new Mt.MathNode("mroot", [Nt(r, t), Nt(n, t)])
            : new Mt.MathNode("msqrt", [Nt(r, t)]);
        },
      });
    var Mn = {
      display: b.DISPLAY,
    ...
    at({
      ...
      htmlBuilder: function (e, t) {
        ...
        i = t.style === b.DISPLAY ? c.sup1 : t.style.cramped ? c.sup3 : c.sup2;
        var v,
          y = t.sizeMultiplier,
          x = 0.5 / c.ptPerEm / y + "em",
          w = null;
        if (a) {
          var k =
            e.base &&
        ...
        if (n && a) {
          ...
          var z = [
            { type: "elem", elem: a, shift: p, marginRight: x, marginLeft: w },
            { type: "elem", elem: n, shift: -u, marginRight: x },
          ];
          v = je.makeVList({ positionType: "individualShift", children: z }, t);
        } else if (a) {
          p = Math.max(p, c.sub1, a.height - 0.8 * c.xHeight);
          var A = [{ type: "elem", elem: a, marginLeft: w, marginRight: x }];
          v = je.makeVList(
        ...
        return je.makeSpan([T], [m, je.makeSpan(["msupsub"], [v])], t);
      },
      mathmlBuilder: function (e, t) {
        var r,
          n = !1;
        ...
        var a,
          i = [Nt(e.base, t)];
        if ((e.sub && i.push(Nt(e.sub, t)), e.sup && i.push(Nt(e.sup, t)), n))
          a = r ? "mover" : "munder";
        else if (e.sub)
          if (e.sup) {
            var o = e.base;
      ...
      at({
        type: "atom",
        htmlBuilder: function (e, t) {
          return je.mathsym(e.text, e.mode, t, ["m" + e.family]);
        },
        mathmlBuilder: function (e, t) {
    ...
    var An = { mi: "italic", mn: "normal", mtext: "normal" };
    at({
      type: "mathord",
      htmlBuilder: function (e, t) {
        return je.makeOrd(e, t, "mathord");
      },
      mathmlBuilder: function (e, t) {
        var r = new Mt.MathNode("mi", [zt(e.text, e.mode, t)]),
          n = Tt(e, t) || "italic";
        return n !== An[r.type] && r.setAttribute("mathvariant", n), r;
      },
    }),
      at({
        type: "textord",
        htmlBuilder: function (e, t) {
          return je.makeOrd(e, t, "textord");
        },
        mathmlBuilder: function (e, t) {
          var r,
            n = zt(e.text, e.mode, t),
            a = Tt(e, t) || "normal";
          return (
            (r =
              "text" === e.mode
                ? new Mt.MathNode("mtext", [n])
                : /[0-9]/.test(e.text)
                ? new Mt.MathNode("mn", [n])
                : "\\prime" === e.text
                ? new Mt.MathNode("mo", [n])
                : new Mt.MathNode("mi", [n])),
            a !== An[r.type] && r.setAttribute("mathvariant", a),
            r
          );
        },
      });
    ...
    at({
      type: "spacing",
      htmlBuilder: function (e, t) {
        if (Bn.hasOwnProperty(e.text)) {
          var r = Bn[e.text].className || "";
          if ("text" === e.mode) {
            var a = je.makeOrd(e, t, "textord");
            return a.classes.push(r), a;
          }
          return je.makeSpan(["mspace", r], [je.mathsym(e.text, e.mode, t)], t);
        }
        if (Tn.hasOwnProperty(e.text))
          return je.makeSpan(["mspace", Tn[e.text]], [], t);
        throw new n('Unknown type of space "' + e.text + '"');
      },
      mathmlBuilder: function (e, t) {
        if (!Bn.hasOwnProperty(e.text)) {
          if (Tn.hasOwnProperty(e.text)) return new Mt.MathNode("mspace");
          throw new n('Unknown type of space "' + e.text + '"');
        }
        return new Mt.MathNode("mtext", [new Mt.TextNode("\xa0")]);
      },
    });
    var qn = function () {
    ...
    at({
      type: "tag",
      mathmlBuilder: function (e, t) {
        var r = new Mt.MathNode("mtable", [
          new Mt.MathNode("mtr", [
            qn(),
            new Mt.MathNode("mtd", [qt(e.body, t)]),
            qn(),
            new Mt.MathNode("mtd", [qt(e.tag, t)]),
          ]),
        ]);
    ...
    var Nn = {
      ...
      Cn = { "\\textbf": "textbf", "\\textmd": "textmd" },
      In = { "\\textit": "textit", "\\textup": "textup" },
      Rn = function (e, t) {
        var r = e.font;
        return r
          ? Nn[r]
            ? t.withTextFontFamily(Nn[r])
            : Cn[r]
            ? t.withTextFontWeight(Cn[r])
            : t.withTextFontShape(In[r])
          : t;
      };
    nt({
      type: "text",
      ...
      handler: function (e, t) {
        var r = e.parser,
          n = e.funcName,
          a = t[0];
        return { type: "text", mode: r.mode, body: ot(a), font: n };
      },
      htmlBuilder: function (e, t) {
        var r = Rn(e, t),
          n = ut(e.body, r, !0);
        return je.makeSpan(["mord", "text"], n, r);
      },
      mathmlBuilder: function (e, t) {
        var r = Rn(e, t);
        return qt(e.body, r);
      ...
      nt({
        ...
        htmlBuilder: function (e, t) {
          var r = bt(e.body, t),
            n = je.makeLineSpan("underline-line", t),
            a = t.fontMetrics().defaultRuleThickness,
            i = je.makeVList(
              {
                positionType: "top",
          ...
          return je.makeSpan(["mord", "underline"], [i], t);
        },
        mathmlBuilder: function (e, t) {
          var r = new Mt.MathNode("mo", [new Mt.TextNode("\u203e")]);
          r.setAttribute("stretchy", "true");
          var n = new Mt.MathNode("munder", [Nt(e.body, t), r]);
          return n.setAttribute("accentunder", "true"), n;
        },
      }),
      nt({
        ...
        mathmlBuilder: function (e, t) {
          return new Mt.MathNode("mpadded", [Nt(e.body, t)], ["vcenter"]);
        },
      }),
      nt({
        type: "verb",
        ...
        htmlBuilder: function (e, t) {
          for (
            var r = On(e), n = [], a = t.havingStyle(t.style.text()), i = 0;
            i < r.length;
            i++
          ) {
            var o = r[i];
            "~" === o && (o = "\\textasciitilde"),
              n.push(
                je.makeSymbol(o, "Typewriter-Regular", e.mode, a, [
                  "mord",
                  "texttt",
                ])
              );
          ...
          return je.makeSpan(
            ["mord", "text"].concat(a.sizingClasses(t)),
            je.tryCombineChars(n),
            a
          );
        },
        mathmlBuilder: function (e, t) {
          var r = new Mt.TextNode(On(e)),
      ...
      Ln = (function () {
        ...
        return (
          (e.prototype.range = function (t, r) {
            return new e(r, Hn.range(this, t));
          }),
          e
        );
      })(),
      ...
      Pn = (function () {
        ...
        return (
          ...
          (t.lex = function () {
            ...
            if (t === e.length) return new Ln("EOF", new Hn(this, t, t));
            var r = this.tokenRegex.exec(e);
            if (null === r || r.index !== t)
              throw new n(
                "Unexpected character: '" + e[t] + "'",
                new Ln(e[t], new Hn(this, t, t + 1))
              );
            var a = r[6] || r[3] || (r[2] ? "\\ " : " ");
            ...
            return new Ln(a, new Hn(this, t, this.tokenRegex.lastIndex));
          }),
          e
        );
      })(),
      ...
      Gn = (function () {
        function e(e, t, r) {
          (this.settings = void 0),
            ...
            this.feed(e),
            (this.macros = new Fn(dn, t.macros)),
            (this.mode = r),
            (this.stack = []);
        }
        var t = e.prototype;
        return (
          (t.feed = function (e) {
            this.lexer = new Pn(e, this.settings);
          }),
          ...
          (t.scanArgument = function (e) {
            ...
            return (
              this.pushToken(new Ln("EOF", r.loc)),
              this.pushTokens(n),
              t.range(r, "")
            );
          }),
          ...
          (t.expandNextToken = function () {
            for (;;) {
              ...
              if (e instanceof Ln) {
                if ("\\relax" !== e.text && !e.treatAsRelax)
          ...
          (t.expandMacro = function (e) {
            return this.macros.has(e) ? this.expandTokens([new Ln(e)]) : void 0;
          }),
            ...
            if ("string" == typeof n) {
              ...
              if (-1 !== n.indexOf("#"))
                for (
                  ...
                  ++a;
              for (
                var o = new Pn(n, this.settings), s = [], l = o.lex();
                "EOF" !== l.text;
          ...
          (t.isExpandable = function (e) {
            ...
            return null != t
              ? "string" == typeof t ||
                  "function" == typeof t ||
                  !t.unexpandable
              : En.hasOwnProperty(e) && !En[e].primitive;
          }),
          e
        );
      })(),
        ...
        return (
          ...
          (t.parseExpression = function (t, r) {
            for (var n = []; ; ) {
              ...
              if (r && a.text === r) break;
              if (t && En[a.text] && En[a.text].infix) break;
    ...
    Wn.endOfExpression = ["}", "\\endgroup", "\\end", "\\right", "&"];
    var Xn = function (e, t) {
    ...
    var jn = function (e, t, r) {
        ...
        var a = je.makeSpan(["katex-error"], [new R(t)]);
        return (
