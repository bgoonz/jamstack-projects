          ...
          <div className="container">
            <div className="row">
              <div className="col-sm-12">
                ...
                <p>
                  <a
                    href="https://rohitgupta.design/oneshopper-gatsby-site"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    https://rohitgupta.design/oneshopper-gatsby-site
                  </a>
                </p>
                <h2>Author</h2>
                <div class="row">
                  ...
                  <div class="col-sm-8">
                    ...
                    <p class="mb-0">
                      <a
                        href="https://rohitgupta.netlify.app/"
                        target="_blank"
                        rel="noopener noreferrer"
                      >
                        Website
                ...
                <p>
                  Checkout my below blog how to Import and Export data from
                  ContentFul
                </p>
                <p>
                  <a
                    href="https://rohitgupta.netlify.app/import-and-export-data-with-contentful-cli"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
