...
1.  Navigate to the ["API Settings"](https://manage.sanity.io/projects/ype85vc2/settings/api) page of this Sanity.io project. Then click "Add new token" and create new "write" token.
...
To start editing your site, you can use the Sanity interface at https://adorable-coriander-fe2e5.sanity.studio/.
...
Generated at `2021-09-01T21:14:59.761Z` by Stackbit version `0.3.55`.
