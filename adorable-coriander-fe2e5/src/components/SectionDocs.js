      ...
      >
        <div className="inner">
          ...
          <div className="block-content">
            ...
            >
              {_.map(
                _.get(this.props, "data.doc_sections.sections", null),
                (doc_section, doc_section_idx) => {
                  let doc_section_path = pathJoin(
                    _.get(this.props, "data.doc_sections.root_docs_path", null),
                    doc_section
                  );
                    ...
                    <div key={doc_section_idx} className="grid-item">
                      <div className="grid-item-inside">
                        <h3 className="grid-item-title line-left">
                          <Link
                            href={withPrefix(
                              _.get(doc_section_page, "stackbit_url_path", null)
                            )}
                          >
                            {_.get(doc_section_page, "title", null)}
                          </Link>
                        </h3>
                        {_.get(doc_section_page, "excerpt", null) && (
