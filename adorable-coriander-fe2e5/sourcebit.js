  ...
  plugins: [
    {
      ...
      options: {
        ...
        projectId: process.env.SANITY_PROJECT_ID || "ype85vc2",
        ...
        pages: [
          {
            ...
            predicate: _.matchesProperty("__metadata.modelName", "docs"),
          },
          {
            path: "/{stackbit_url_path}",
        ...
        commonProps: (items) => {
          return {
            pages: _.filter(items, (item) =>
              ["docs", "advanced", "blog", "page", "post"].includes(
            ...
            data: {
              ...
              doc_sections: _.find(
                items,
                _.matchesProperty("__metadata.modelName", "doc_sections")
              ),
            },
          };
        },
