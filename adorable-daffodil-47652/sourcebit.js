        ...
        pages: [
          {
            ...
            predicate: _.matchesProperty("__metadata.modelName", "home"),
          },
          {
            path: "/{__metadata.urlPath}",
          ...
          {
            path: "/{__metadata.urlPath}",
            predicate: _.matchesProperty("__metadata.modelName", "store"),
          },
          {
            path: "/{__metadata.urlPath}",
            predicate: _.matchesProperty("__metadata.modelName", "category"),
          },
          {
            path: "/{__metadata.urlPath}",
            predicate: _.matchesProperty("__metadata.modelName", "product"),
          },
        ],
        commonProps: {
          pages: {
