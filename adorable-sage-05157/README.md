...
1.  Navigate to the ["API Settings"](https://manage.sanity.io/projects/sqyyyh2o/settings/api) page of this Sanity.io project. Then click "Add new token" and create new "write" token.
...
To start editing your site, you can use the Sanity interface at https://adorable-sage-05157.sanity.studio/.
...
Generated at `2021-03-04T03:18:01.957Z` by Stackbit version `0.3.50`.
