...
export default class Product extends React.Component {
  render() {
    let primary_bg_img_opacity_pct =
      _.get(
        this.props,
        "pageContext.site.siteMetadata.bg_image_primary_opacity",
        null
      ) || 100;
        ...
        <main className="content">
          <section className="product content__row content__row--full-width">
            <div className="product__background-left">
              {_.get(
                this.props,
                "pageContext.site.siteMetadata.bg_image_primary",
                null
              ) && (
                <div
                  className="product__background-left-img"
                  style={toStyleObj(
            ...
            {_.get(
              this.props,
              "pageContext.site.siteMetadata.bg_image_secondary",
              null
            ) && (
              <div
            ...
            <figure className="product__figure">
              <Picture
                ...
                image={_.get(
                  this.props,
                  "pageContext.frontmatter.default_original_image",
                  null
                )}
            ...
            <div className="product__details">
              ...
              {_.get(this.props, "pageContext.frontmatter.category", null) &&
                (() => {
                  let category_page = getPageByFilePath(
                    this.props.pageContext.pages,
                    _.get(this.props, "pageContext.frontmatter.category", null)
                  );
                  return (
                    <h2 className="product__category">
                      <Link to={withPrefix(_.get(category_page, "url", null))}>
                        {" "}
                        {_.get(category_page, "frontmatter.title", null)}{" "}
                      </Link>
                    </h2>
                  );
                })()}
              ...
              <BuyButton
                {...this.props}
                product_page={this.props.pageContext}
              />
            </div>
          </section>
          {_.get(this.props, "pageContext.frontmatter.category", null) &&
            (() => {
              let product_pages = _.filter(
                _.orderBy(
                  getPages(this.props.pageContext.pages, "/products"),
                  "frontmatter.order"
                ),
                (item) =>
                  _.get(item, "frontmatter.id") !=
                  _.get(this.props, "pageContext.frontmatter.id", null)
              );
              let category_page = getPageByFilePath(
                this.props.pageContext.pages,
                _.get(this.props, "pageContext.frontmatter.category", null)
          ...
          <Link
            ...
            {...(_.get(
              this.props,
              "pageContext.site.siteMetadata.bg_image_product",
              null
            )
              ? {
                  style: toStyleObj(
