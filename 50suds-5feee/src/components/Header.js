      ...
      <React.Fragment>
        <header className="header">
          ...
          >
            <div
              className="nav__logo"
              {...(is_logo_light && _.get(site, "siteMetadata.logo_light", null)
                ? {
                    "data-original": withPrefix(
                      _.get(site, "siteMetadata.logo_light", null)
                    ),
                  }
                : null)}
              {...(_.get(site, "siteMetadata.logo_dark", null)
                ? {
            ...
            <div className="nav__right">
              ...
              <div
                ...
                {...(_.get(
                  site,
                  "siteMetadata.hamburger_background_image",
                  null
                )
                  ? {
                      style: toStyleObj(
