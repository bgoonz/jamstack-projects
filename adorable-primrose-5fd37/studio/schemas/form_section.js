export default {
  ...
  fields: [
    ...
    },
    {
      ...
      title: "Form position",
      description:
        "The position of the form relative to the text content of the section",
      initialValue: "bottom",
      validation: null,
      options: {
    ...
    },
    {
      ...
      title: "Form width",
      description:
        'The form container width as a percentage of the section width. Used only when the form position is set to "left" or "right"',
      initialValue: "fifty",
      validation: null,
      options: {
        list: ["fourty", "fifty", "sixty"],
      },
    },
    {
      type: "string",
      ...
      title: "Form layout",
      description:
        'The layout of the form. "Inline" layout can only be used if the form has one input field',
    ...
    },
    {
      ...
      description:
        "Display form inside a box, i.e. add border and background to the form container",
      validation: null,
    },
    {
      type: "string",
    ...
    },
    {
      ...
      description:
        'The vertical alignment of the section text content and form. Used only when the form position is set to "left" or "right"',
      initialValue: "top",
      validation: null,
      options: {
    ...
    },
    {
      ...
      description:
        "An integer between 0 and 100. A lower value makes the image more transparent",
    ...
    },
    {
      ...
      description:
        "The starting position of a background image. The first value is the horizontal position, and the second value is the vertical",
