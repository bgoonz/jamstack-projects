export default {
  ...
  fields: [
    ...
    },
    {
      ...
      description:
        'The image or video container width as a percentage of the feature width. Used only when the image or video position is set to "left" or "right"',
      initialValue: "fifty",
      validation: null,
      options: {
        list: ["thirty-three", "fourty", "fifty", "sixty"],
      },
    },
    {
      type: "string",
