export default {
  ...
  fields: [
    ...
    },
    {
      ...
      description:
        "The position of the image or video relative to the text content",
      initialValue: "top",
      validation: null,
      options: {
    ...
    },
    {
      ...
      description:
        'The image or video container width as a percentage of the section width. Used only when the image or video position is set to "left" or "right"',
      initialValue: "fifty",
      validation: null,
      options: {
