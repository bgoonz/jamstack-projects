export default {
  ...
  fields: [
    ...
    },
    {
      ...
      description:
        'The image container width as a percentage of the item width. Used only when the image position is set to "left" or "right"',
      initialValue: "fifty",
      validation: null,
      options: {
        list: ["twenty-five", "thirty-three", "fourty", "fifty", "sixty"],
      },
    },
    {
      type: "string",
    ...
    },
    {
      ...
      title: "Image padding",
      description:
        'Add padding (space) around the image. Used only when "Enable cards" is set to true',
      validation: null,
    },
    {
      type: "string",
