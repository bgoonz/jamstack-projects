export default {
  ...
  fields: [
    ...
    },
    {
      ...
      title: "Enable cards",
      description:
        "Display posts as cards, i.e. add border, background and some padding around post content",
      validation: null,
    },
    {
      type: "boolean",
      ...
      description:
        "Show the specified number of recent posts. Should not be used with author, category and tag filters",
    ...
    },
    {
      ...
      description:
        "The horizontal alignment of the section content (title, subtitle, action buttons)",
      initialValue: "center",
      validation: null,
      options: {
