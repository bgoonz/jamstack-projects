export default {
  ...
  fields: [
    ...
    },
    {
      ...
      description:
        "Display the navigation menu on the left side, next to the site title/logo",
      initialValue: true,
      validation: null,
    },
    {
    ...
    },
    {
      ...
      description:
        "A unique identifier, required if close button is enabled. Must be updated each time the announcement content changes",
      validation: null,
    },
    {
      type: "string",
