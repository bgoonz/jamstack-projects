export default {
  ...
  fields: [
    ...
    },
    {
      ...
      description:
        "The position of action buttons relative to the text content",
      initialValue: "bottom",
      validation: null,
      options: {
    ...
    },
    {
      ...
      description:
        'The action buttons container width as a percentage of the section width. Used only when the action buttons position is set to "left" or "right"',
      initialValue: "fourty",
      validation: null,
      options: {
