...
1.  Navigate to the ["API Settings"](https://manage.sanity.io/projects/y29e8knq/settings/api) page of this Sanity.io project. Then click "Add new token" and create new "write" token.
...
To start editing your site, you can use the Sanity interface at https://adorable-primrose-5fd37.sanity.studio/.
...
Generated at `2021-03-20T13:50:01.042Z` by Stackbit version `0.3.50`.
