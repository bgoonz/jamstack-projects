...
1.  Navigate to the ["API Settings"](https://manage.sanity.io/projects/bel5cdqh/settings/api) page of this Sanity.io project. Then click "Add new token" and create new "write" token.
...
To start editing your site, you can use the Sanity interface at https://adorable-saturn-f97de.sanity.studio/.
...
Generated at `2021-05-27T13:01:50.958Z` by Stackbit version `0.3.53`.
