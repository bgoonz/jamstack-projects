  ...
  render() {
    ...
    return (
      <section
        ...
        className={
          "block faq-block bg-" + _.get(section, "background", null) + " outer"
        }
      >
              ...
              {_.map(
                ...
                (faqitem, faqitem_idx) => (
                  <React.Fragment key={faqitem_idx + ".2"}>
                    <h3
                      key={faqitem_idx}
                      className="faq-accordion-header handorgel__header"
                    >
                    ...
                    <div
                      key={faqitem_idx + ".1"}
                      className="faq-accordion-content handorgel__content"
                    >
