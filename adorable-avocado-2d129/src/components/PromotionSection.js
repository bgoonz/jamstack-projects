    ...
    return (
      ...
      >
        <div className="promo">
          <Picture
            {...this.props}
            image={_.get(section, "image", null)}
          ...
          >
            ...
            {_.get(section, "cta", null) &&
              (() => {
                ...
                return (
                  <Link
                    className={classNames("link", "promo__link", {
                      "link--light-filled": cta_style === "primary",
                      "link--light": cta_style === "secondary",
                      "link--light-borderless": cta_style === "link",
                    })}
                    href={_.get(section, "cta.url", null)}
                  >
