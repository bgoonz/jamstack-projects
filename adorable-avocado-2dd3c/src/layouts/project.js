  ...
  render() {
    ...
    return (
      <Layout {...this.props}>
        <article className="project">
          <header className="project__header">
            <div className="container container--md">
              <h1 className="project__title line-top">
          ...
          <div className="project__body">
            {_.map(
              _.get(this.props, "page.frontmatter.sections", null),
              (section, section_idx) => {
        ...
        {_.map(
          projects_sorted,
          (project_item, project_item_idx) =>
            _.get(project_item, "__metadata.urlPath", null) ===
