...
export default class Product extends React.Component {
  render() {
    let primary_bg_img_opacity_pct =
      _.get(this.props, "data.config.bg_image_primary_opacity", null) || 100;
      ...
      <Layout {...this.props}>
        <main className="content">
          <section className="product content__row content__row--full-width">
            ...
            <figure className="product__figure">
              <Picture
                ...
                image={_.get(
                  this.props,
                  "page.frontmatter.default_original_image",
                  null
                )}
                alt={_.get(this.props, "page.frontmatter.title", null)}
                ...
                (() => {
                  ...
                  return (
                    <h2 className="product__category">
                      <Link
                        href={withPrefix(
                          _.get(category_page, "__metadata.urlPath", null)
                        )}
                      >
                        {" "}
          ...
          {_.get(this.props, "page.frontmatter.category", null) &&
            (() => {
              let product_pages = _.filter(
                _.orderBy(
                  getPages(this.props.pages, "/products"),
                  "frontmatter.order"
                ),
                (item) =>
                  _.get(item, "frontmatter.id") !=
                  _.get(this.props, "page.frontmatter.id", null)
              );
              let category_page = getPageByFilePath(
                this.props.pages,
                _.get(this.props, "page.frontmatter.category", null)
          ...
          <Link
            ...
            {...(_.get(this.props, "data.config.bg_image_product", null)
              ? {
                  style: toStyleObj(
                    "background-image: url('" +
                      withPrefix(
