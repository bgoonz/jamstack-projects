      ...
      <li className="product-grid__item">
        <figure className="product-grid__item-figure">
          <Link
            ...
            href={withPrefix(_.get(product_page, "__metadata.urlPath", null))}
          >
            <Picture
              {...this.props}
              image={_.get(
                product_page,
                "frontmatter.default_thumbnail_image",
                null
              )}
              alt={_.get(product_page, "frontmatter.title", null)}
        ...
        <div className="product-grid__definition">
          ...
          <span className="product-grid__price">
            {" "}
            ${_.get(product_page, "frontmatter.price", null)}{" "}
          </span>
        </div>
      </li>
    );
