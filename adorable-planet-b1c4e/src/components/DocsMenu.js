            ...
            <ul id="docs-menu" className="docs-menu">
              <li
                className={classNames("docs-menu-item", {
                  current:
                    _.get(page, "__metadata.urlPath", null) ===
                    _.get(root_page, "__metadata.urlPath", null),
                })}
              >
                <Link
                  href={withPrefix(
              ...
              {_.map(
                ...
                (section, section_idx) => {
                  ...
                  let is_current_page =
                    _.get(page, "__metadata.urlPath", null) ===
                    _.get(section_page, "__metadata.urlPath", null)
                      ? true
                      : false;
                  let is_active = _.get(
                    page,
                    "__metadata.urlPath",
                    null
                  ).startsWith(_.get(section_page, "__metadata.urlPath", null));
                  return (
