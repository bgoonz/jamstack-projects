...
Adding the above to `_config.yml` will assign the `single` layout and enable: _author profile_, _reading time_, _comments_, [*social sharing links*]({{ "/docs/layouts/#social-sharing-links" | relative_url }}), and _related posts_, for all posts.
