...
!(function (e, t) {
      ...
      if (!r && (C(e), (e = e || T), E)) {
        ...
        if (
          ...
          if (((c = t), (f = e), 1 === d && (Q.test(t) || X.test(t)))) {
            for (
              ((f = (ne.test(t) && ve(e.parentNode)) || e) === e && p.scope) ||
                ((s = e.getAttribute("id"))
                  ? (s = s.replace(ie, oe))
      ...
      return (
        ...
        le(function (e, t, n, r) {
          var i,
            ...
            d = m ? (v || (e ? p : l || g) ? [] : t) : f;
          if ((m && m(f, d, n, r), g))
            for (i = Ce(d, u), g(i, [], n, r), o = i.length; o--; )
              (a = i[o]) && (d[u[o]] = !(f[u[o]] = a));
          if (e) {
            if (v || p) {
              if (v) {
          ...
          } else (d = Ce(d === t ? d.splice(l, d.length) : d)), v ? v(null, t, d, r) : H.apply(t, d);
        })
      );
    }
    function Ee(e) {
      ...
      function (r, i) {
        S.fn[r] = function (e, t) {
          ...
          return (
            ...
            1 < this.length &&
              (O[r] || S.uniqueSort(n), D.test(r) && n.reverse()),
            this.pushStack(n)
          );
        };
      }
          ...
          a = {
            ...
            then: function (t, n, r) {
                  ...
                  function e() {
                    ...
                    if (!(i < u)) {
                      ...
                      (t =
                        ...
                        b(t)
                          ? s
                            ? t.call(e, l(u, o, q, s), l(u, o, M, s))
                            : (u++,
                              t.call(
                                e,
                                l(u, o, q, s),
                                l(u, o, M, s),
                                l(u, o, q, o.notifyWith)
                              ))
                          : (a !== q && ((n = void 0), (r = [e])),
                            (s || o.resolveWith)(n, r));
                    }
              ...
              return S.Deferred(function (e) {
                o[0][3].add(l(0, e, b(r) ? r : q, e.notifyWith)),
                  o[1][3].add(l(0, e, b(t) ? t : q)),
                  o[2][3].add(l(0, e, b(n) ? n : M));
              }).promise();
            },
            promise: function (e) {
  ...
  function Ae(e, i, o) {
    o
      ...
      : void 0 === V.get(e, i) && S.event.add(e, i, Te);
  }
  (S.event = {
    global: {},
        ...
        for (l = (t = (t || "").match(H) || [""]).length; l--; )
          if (
            ...
            a &&
              ...
              delete u[p]);
          } else for (p in u) S.event.remove(e, p + t[l], n, r, !0);
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          var t = this || e;
          return (
            de.test(t.type) && t.click && A(t, "input") && Ae(t, "click", Te),
            !1
          );
        },
        trigger: function (e) {
          var t = this || e;
          return (
            de.test(t.type) && t.click && A(t, "input") && Ae(t, "click"), !0
          );
        },
        _default: function (e) {
          var t = e.target;
  ...
  function He(n, r, i, o) {
    ...
    var e,
      ...
      p = r[0],
      h = b(p);
    if (h || (1 < f && "string" == typeof p && !y.checkClone && je.test(p)))
    ...
    if (
      ...
      for (s = (a = S.map(ge(e, "script"), De)).length; c < f; c++)
        (u = e),
          c !== d &&
            ((u = S.clone(u, !0, !0)), s && S.merge(a, ge(u, "script"))),
          i.call(n[c], u, c);
      if (s)
        for (l = a[a.length - 1].ownerDocument, S.map(a, Oe), c = 0; c < s; c++)
          (u = a[c]),
            he.test(u.type || "") &&
              ...
              (u.src && "module" !== (u.type || "").toLowerCase()
                ...
                : x(u.textContent.replace(Ie, ""), u, l));
    }
    return n;
  }
  function qe(e, t, n) {
  ...
  function Ve() {
    if (Ue) {
      (We.style.cssText =
        ...
        re.appendChild(We).appendChild(Ue);
      var e = T.getComputedStyle(Ue);
      (_e = "1%" !== e.top),
        (ze = 12 === Ge(e.marginLeft)),
        (Ue.style.right = "60%"),
        (Be = 36 === Ge(e.right)),
        ($e = 36 === Ge(e.width)),
        ...
        reliableTrDimensions: function () {
          ...
          return (
            null == Fe &&
              ...
              (r = T.getComputedStyle(t)),
              (Fe = 3 < parseInt(r.height)),
              re.removeChild(e)),
            Fe
          );
        },
    ...
    style: function (e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var i,
          ...
          l = e.style;
        if (
          (u || (t = nt(s)), (a = S.cssHooks[t] || S.cssHooks[s]), void 0 === n)
        )
  ...
  function vt() {
    dt &&
      (!1 === E.hidden && T.requestAnimationFrame
        ? T.requestAnimationFrame(vt)
        : T.setTimeout(vt, S.fx.interval),
      S.fx.tick());
  }
  function yt() {
    return (
      ...
      function (e, t, n) {
        ...
        if ((u = !S.isEmptyObject(t)) || !S.isEmptyObject(p))
          for (r in (f &&
            ...
            null == (l = g && g.display) && (l = V.get(e, "display")),
          ...
          p))
            u ||
              (g
                ...
                : (g = V.access(e, "fxshow", { display: l })),
              o && (g.hidden = !m),
              m && le([e], !0),
              d.done(function () {
                for (r in (m || le([e]), V.remove(e, "fxshow"), p))
                  S.style(e, r, p[r]);
              })),
              (u = xt(m ? g[r] : 0, r, d)),
              r in g ||
        ...
        return "boolean" == typeof t && a
          ...
          : this.each(function () {
              ...
              if (a)
                ...
                (void 0 !== i && "boolean" != o) ||
                  ((e = At(this)) && V.set(this, "__className__", e),
                  this.setAttribute &&
                    this.setAttribute(
                      "class",
        ...
        return (
          ...
          r ||
            ...
            (u &&
              ...
              ((a = n[u]) && (n[u] = null),
              (S.event.triggered = p),
              e.isPropagationStopped() && f.addEventListener(p, It),
              n[p](),
              e.isPropagationStopped() && f.removeEventListener(p, It),
    ...
    S.extend({
      ...
      ajax: function (e, t) {
        ...
        if (
          ...
          try {
            (r.href = g.url),
              (r.href = r.href),
              (g.crossDomain =
                Vt.protocol + "//" + Vt.host != r.protocol + "//" + r.host);
          } catch (e) {
            g.crossDomain = !0;
          }
        }
        ...
        g.hasContent
          ...
          : ((o = g.url.slice(f.length)),
            g.data &&
              ...
              ((f += (Pt.test(f) ? "&" : "?") + g.data), delete g.data),
            !1 === g.cache &&
              ((f = f.replace(Ft, "$1")),
              (o = (Pt.test(f) ? "&" : "?") + "_=" + Ot.guid++ + o)),
            (g.url = f + o)),
        g.ifModified &&
          (S.lastModified[f] &&
        ...
        if (
          ...
          if (((C.readyState = 1), m && y.trigger("ajaxSend", [C, g]), h))
            return C;
          g.async &&
            0 < g.timeout &&
        ...
        function l(e, t, n, r) {
          ...
          h ||
            ...
            !i &&
              -1 < S.inArray("script", g.dataTypes) &&
            ...
            (C.status = e),
            (C.statusText = (t || l) + ""),
            i ? b.resolveWith(v, [o, l, C]) : b.rejectWith(v, [C, l, a]),
            C.statusCode(w),
            (w = void 0),
            m && y.trigger(i ? "ajaxSuccess" : "ajaxError", [C, g, i ? o : a]),
            x.fireWith(v, [C, l]),
            m &&
  ...
  S.ajaxSetup({
    ...
    jsonpCallback: function () {
      var e = nn.pop() || S.expando + "_" + Ot.guid++;
      return (this[e] = !0), e;
    },
  }),
  ...
  return (
    (S.noConflict = function (e) {
      return T.$ === S && (T.$ = sn), e && T.jQuery === S && (T.jQuery = an), S;
    }),
    ...
    o.fn.fitVids = function (e) {
      ...
      return (
        ...
        this.each(function () {
          ...
          (t = (t = t.not("object object")).not(i)).each(function (e) {
            var t = o(this);
            if (
              !(
                0 < t.parents(i).length ||
  ...
  $(function () {
    var r,
      ...
      a = $("nav.greedy-nav .visible-links"),
      s = $("nav.greedy-nav .hidden-links"),
      n = $("nav.greedy-nav"),
    ...
    function d() {
      ...
      (i = r = 0),
        (e = 1e3),
        (o = []),
        a.children().outerWidth(n),
        s.children().each(function () {
          var e, t;
          (e = $(this)),
            (t = e.clone()).css("visibility", "hidden"),
            a.append(t),
            n(0, t.outerWidth()),
            t.remove();
        });
    ...
    function b() {
      ...
      e !== y && d(),
        ...
        (m = o[h - 1]),
        p < m
          ? (a.children().last().prependTo(s), --h, b())
          : p + (h === o.length - 1 ? t.outerWidth(!0) : 0) > o[h] &&
            (s.children().first().appendTo(a), (h += 1), b()),
        t.attr("count", r - h),
        h === r ? t.addClass("hidden") : t.removeClass("hidden");
    }
    $(window).resize(function () {
      b();
    }),
      t.on("click", function () {
        s.toggleClass("hidden"), clearTimeout(g);
      }),
      s
  ...
  (function (e) {
    ...
    function d(e, t, n, r) {
      ...
      return (
        (i.className = "mfp-" + e),
        n && (i.innerHTML = n),
        r ? t && t.appendChild(i) : ((i = c(i)), t && i.appendTo(t)),
        i
      );
    }
    function p(e, t) {
    ...
    (e.prototype = {
      ...
      open: function (e) {
        ...
        if (!m.isOpen) {
          (m.types = []),
            ...
            m.bgOverlay ||
              ((m.bgOverlay = d("bg").on("click" + x, function () {
                m.close();
              })),
              (m.wrap = d("wrap")
                .attr("tabindex", -1)
          ...
          p("BeforeOpen"),
            ...
            m.fixedContentPos
              ...
              : m.wrap.css({ top: C.scrollTop(), position: "absolute" }),
            (!1 !== m.st.fixedBgPos &&
          ...
          return (
            ...
            setTimeout(function () {
              m.content
                ? (m._addClassToMFP(w), m._setFocus())
                : m.bgOverlay.addClass(w),
      ...
      _close: function () {
        ...
        if (
          ...
          var t = { marginRight: "" };
          m.isIE7 ? c("body, html").css("overflow", "") : (t.overflow = ""),
            c("html").css(t);
        }
      ...
      updateItemHTML: function () {
        ...
        var r = m["get" + t.charAt(0).toUpperCase() + t.slice(1)](
          e,
          m.currTemplate[t]
        );
        m.appendContent(r, t),
      ...
      appendContent: function (e, t) {
        (m.content = e)
          ? m.st.showCloseBtn && m.st.closeBtnInside && !0 === m.currTemplate[t]
            ? m.content.find(".mfp-close").length || m.content.append(h())
            : (m.content = e)
          : (m.content = ""),
          p("BeforeAppend"),
      ...
      updateStatus: function (e, t) {
        if (m.preloader) {
          r !== e && m.container.removeClass("mfp-s-" + r),
      ...
      (c.fn.magnificPopup = function (e) {
        ...
        if ("string" == typeof e)
          if ("open" === e) {
            var n,
              r = s ? t.data("magnificPopup") : t[0].magnificPopup,
              i = parseInt(arguments[1], 10) || 0;
            (n = r.items
              ? r.items[i]
              : ((n = t), r.delegate && (n = n.find(r.delegate)), n.eq(i))),
              m._openClick({ mfpEl: n }, t, r);
          } else
            m.isOpen && m[e].apply(m, Array.prototype.slice.call(arguments, 1));
        else
          (e = c.extend(!0, {}, e)),
        ...
        getInline: function (e, t) {
          if ((T(), e.src)) {
            ...
            if (r.length) {
              ...
              i &&
                i.tagName &&
                (S || ((E = n.hiddenClass), (S = d(E)), (E = "mfp-" + E)),
                (k = r.after(S).detach().removeClass(E))),
      ...
      proto: {
        initImage: function () {
          ...
          m.types.push("image"),
            ...
            f("Resize" + t, m.resizeImage),
            m.isLowIE && f("AfterChange", m.resizeImage);
        },
        ...
        getImage: function (e, t) {
          ...
          if (a.length) {
            ...
            (s.className = "mfp-img"),
              ...
              (e.img = c(s).on("load.mfploader", r).on("error.mfploader", i)),
              (s.src = e.src),
              a.is("img") && (e.img = e.img.clone()),
              0 < (s = e.img[0]).naturalWidth
                ? (e.hasSize = !0)
                : s.width || (e.hasSize = !1);
          }
          return (
          ...
          if (o.enabled && m.supportsTransition) {
            function n(e) {
              var t = e
                ...
                i = "transition";
              return (
                (r["-webkit-" + i] = r["-moz-" + i] = r["-o-" + i] = r[i] = n),
                t.css(r),
                t
              );
            }
    ...
    c.magnificPopup.registerModule("gallery", {
      ...
      proto: {
          ...
          (v += " mfp-gallery"),
            ...
            f("BuildControls" + e, function () {
              if (1 < m.items.length && o.arrows && !m.arrowLeft) {
                var e = o.arrowMarkup,
                  t = (m.arrowLeft = c(
                    e.replace(/%title%/gi, o.tPrev).replace(/%dir%/gi, "left")
                  ).addClass(a)),
                  n = (m.arrowRight = c(
                    e.replace(/%title%/gi, o.tNext).replace(/%dir%/gi, "right")
                  ).addClass(a));
                t.click(function () {
                  m.prev();
                }),
        ...
        preloadNearbyImages: function () {
          ...
          for (e = 1; e <= (m.direction ? r : n); e++)
            m._preloadItem(m.index + e);
          for (e = 1; e <= (m.direction ? n : r); e++)
            m._preloadItem(m.index - e);
        },
  ...
  (function (e, t) {
    ...
    function (A) {
      ...
      function I(e) {
        return e
          ? ((t = e), parseInt(A.getComputedStyle(t).height, 10) + e.offsetTop)
          : 0;
        var t;
      }
      function L(e, t, n, r) {
      ...
      return function (r, e) {
        var T,
          ...
          S,
          k = {};
        (k.cancelScroll = function (e) {
          cancelAnimationFrame(S), (S = null), e || L("scrollCancel", T);
        }),
          (k.animateScroll = function (a, s, e) {
            k.cancelScroll();
            var u = N(T || D, e || {}),
              l = "[object Number]" === Object.prototype.toString.call(a),
              t = l || !a.tagName ? null : a;
            if (l || t) {
              var c = A.pageYOffset;
              u.header && !E && (E = document.querySelector(u.header));
              var n,
                r,
                i,
                f,
                ...
                g = l
                  ...
                  : (function (e, t, n, r) {
                      ...
                      return (
                        (i = Math.max(i - t - n, 0)),
                        r && (i = Math.min(i, j() - A.innerHeight)),
                        i
                      );
                    })(
                      t,
                ...
                x =
                  ((n = v),
                  (i = (r = u).speedAsDuration
                    ? r.speed
                    : Math.abs((n / 1e3) * r.speed)),
                  r.durationMax && i > r.durationMax
                    ? r.durationMax
                    : r.durationMin && i < r.durationMin
                    ? r.durationMin
                    : parseInt(i, 10)),
                w = function (e, t) {
                  var n,
                    ...
                    i,
                    o = A.pageYOffset;
                  if (e == t || o == t || (c < t && A.innerHeight + o) >= y)
                    return (
                      k.cancelScroll(!0),
                      (r = t),
                      (i = l),
                      0 === (n = a) && document.body.focus(),
                      i ||
                        (n.focus(),
                ...
                C = function (e) {
                  ...
                  (b += e - (f = f || e)),
                    (d =
                      c +
                      v *
                        ((n = o = 1 < (o = 0 === x ? 0 : b / x) ? 1 : o),
                        "easeInQuad" === (t = u).easing && (r = n * n),
                        ...
                        "easeInOutQuint" === t.easing &&
                          (r =
                            n < 0.5
                              ? 16 * n * n * n * n * n
                              : 1 + 16 * --n * n * n * n * n),
                        t.customEasing && (r = t.customEasing(n)),
                        r || n)),
                    A.scrollTo(0, Math.floor(d)),
                    w(d, g) || ((S = A.requestAnimationFrame(C)), (f = e));
                };
              0 === A.pageYOffset && A.scrollTo(0, 0),
                ...
                l ||
                  (history.pushState &&
                    h.updateURL &&
                    history.pushState(
                      { smoothScroll: JSON.stringify(h), anchor: p.id },
                      document.title,
                      p === document.documentElement ? "#top" : "#" + p.id
                    )),
                "matchMedia" in A &&
                A.matchMedia("(prefers-reduced-motion)").matches
                  ? A.scrollTo(0, Math.floor(g))
                  : (L("scrollStart", u, a, s),
                    k.cancelScroll(!0),
        ...
        function t(e) {
          if (
            ...
            "closest" in e.target &&
            (i = e.target.closest(r)) &&
            "a" === i.tagName.toLowerCase() &&
            !e.target.closest(T.ignore) &&
            i.hostname === A.location.hostname &&
            i.pathname === A.location.pathname &&
            /#/.test(i.href)
          ) {
            var t, n;
            try {
              t = o(decodeURIComponent(i.hash));
            } catch (e) {
              t = o(i.hash);
            }
            if ("#" === t) {
              if (!T.topOnEmptyHash) return;
        ...
        function n(e) {
          if (
            ...
            history.state.smoothScroll === JSON.stringify(T)
          ) {
            var t = history.state.anchor;
            ("string" == typeof t &&
              t &&
              !(t = document.querySelector(o(history.state.anchor)))) ||
              k.animateScroll(t, null, { updateURL: !1 });
          }
        }
        k.destroy = function () {
          T &&
            (document.removeEventListener("click", t, !1),
            A.removeEventListener("popstate", n, !1),
            k.cancelScroll(),
            (S = E = i = T = null));
        };
        return (
          (function () {
            ...
            k.destroy(),
              (T = N(D, e || {})),
              (E = T.header ? document.querySelector(T.header) : null),
      ...
      return function (e, t) {
        ...
        function u(e) {
          o && c.cancelAnimationFrame(o),
            (o = c.requestAnimationFrame(s.detect));
        }
        function l(e) {
          o && c.cancelAnimationFrame(o),
