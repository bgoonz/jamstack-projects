...
export default class ContactSection extends React.Component {
  render() {
    ...
    return (
      <section
        className="content__row content__row--full-width contact__section"
        ...
        <div className="contact__text-container">
          ...
          <div className="contact__info-container">
            ...
            {_.get(section, "mapUrl", null) && (
              <Link
                className="contact__map-link link link--filled link--reversed"
                href={_.get(section, "mapUrl", null)}
              >
                On the map
                <svg
                  width="17"
