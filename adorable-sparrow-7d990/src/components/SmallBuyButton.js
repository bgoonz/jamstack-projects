...
export default class SmallBuyButton extends React.Component {
  render() {
    ...
    return (
      <button
        className={
          component + "__item-buy button button--icon-only snipcart-add-item"
        }
        ...
        {...(_.get(product_page, "frontmatter.category", null)
          ...
          : null)}
        {...(_.get(product_page, "frontmatter.default_thumbnail_image", null)
          ? {
              "data-item-image": withPrefix(
                _.get(product_page, "frontmatter.default_thumbnail_image", null)
              ),
            }
          : null)}
        data-item-description={_.get(
          product_page,
      ...
      >
        ...
        >
          ...
          <path d="M11.4678 22.4455C11.4678 23.3034 10.7781 24 9.92751 24C9.07596 24 8.38623 23.3034 8.38623 22.4455C8.38623 21.5877 9.07596 20.891 9.92751 20.891C10.7781 20.891 11.4678 21.5877 11.4678 22.4455Z" />
          <path d="M19.4244 22.4455C19.4244 23.3034 18.7346 24 17.8841 24C17.0325 24 16.3428 23.3034 16.3428 22.4455C16.3428 21.5877 17.0325 20.891 17.8841 20.891C18.7346 20.891 19.4244 21.5877 19.4244 22.4455Z" />
