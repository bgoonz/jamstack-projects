    ...
    return (
      ...
      >
        ...
        <div className="quotes">
          {_.map(testimonials, (testimonial, testimonial_idx) => (
            <React.Fragment key={testimonial_idx + ".2"}>
              <div key={testimonial_idx} className="quotes__item">
                ...
                >
                  <path d="M0 14.1818L4.57143 0H9.52381L5.71429 13.2893H9.52381V24H0V14.1818ZM14.4762 14.1818L19.0476 0H24L20.1905 13.2893H24V24H14.4762V14.1818Z" />
                </svg>
                <div className="quotes__text">
                  {_.get(testimonial, "text", null)}
                </div>
                <div className="quotes__author">
                  {_.get(testimonial, "author.name", null)}
                  <span className="quotes__location">
                    ,{_.get(testimonial, "author.location", null)}
                  </span>
                </div>
              </div>
