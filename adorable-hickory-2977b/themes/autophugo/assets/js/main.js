(function ($) {
  ...
  $(function () {
    ...
    $main.children(".thumb").each(function () {
      ...
      // Set background position.
      if ((x = $link_img.data("position"))) $link.css("background-position", x);
    ...
    var gallery_items = $(".gallery-item").sort(function (item_a, item_b) {
      return (
        item_a.getAttribute("gallery_index") -
      ...
      image: {
        titleSrc: function (item) {
          ...
          if (item.el.attr("description")) {
            caption +=
              '<p class="description">' + item.el.attr("description") + "</p>";
          }
          caption += "</div>";
          return caption;
        },
